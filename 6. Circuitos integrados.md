...
3) El capacitor se va cargando hasta que $V_{th}>\frac{1}{3}V_{cc}$ (que es la comparacion que se esta haciendo en el OpAmp de  $V_{th}$ contra el divisor de tension.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA0MjIxNjIwMywtNzAwNjE2OTI5LC01Nz
