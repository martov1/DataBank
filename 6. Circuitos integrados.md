...
![](https://i.imgur.com/uea9MlF.png)3) Al apretar el pulsador, $V_{tr}=0$. Entonces el flipflop ahora tiene su $S=high$ y su $R=low$ la memoria cambia, $\bar{Q}=$
![](https://i.imgur.com/cVsFnFM.png)



<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY3Mzk4NTQ0MywtNTcxODM2NTc5LC0zNj
