...
![](https://i.imgur.com/uea9MlF.png)3) Al apretar el pulsador, $V_{tr}=0$. Entonces por un instante el flipflop  tiene su $S=high$ y su $R=low$ la memoria cambia, $\bar{Q}=0$.
osea que
	* **DIS** ya no deja descargar el capacitor
	* La **salida se enciende** (por que niega el valor de $\bar{Q}$) 
![](https://i.imgur.com/cVsFnFM.png)![](https://i.imgur.com/iDI2XKn.png)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MDQ3Nzc0MzAsMTUzNDA3NDc4NCwtNz
AwNjE2OTI5LC01NzE4MzY1NzksLTM2Mzg5MDAzMiwtMTM1NDU0
ODY0LDQ4NDMyMDU0NCwxMDk3MDA3MTUzLC03MTg1MDg0NzcsLT
E2NTc4ODYwMjUsMjA4MzQ0MjAyMSwtMTYyNTA0NzcwMV19
-->