...
1.	Notamos que para que $Q_2$ conduzca, en su base debe haber una tension $V_{Q_2b}$ superior que la tension de ruptura del diodo   de la base $V_be$ y del zener $V_z$.
	*	 entonces $Q_2$ **conduce cuando**  $V_{Q_2b}>V_z+V_{be}$
2.  Recordamos la regla del divisor de tension $V_{out}=V_{in}\frac{R_2}{R_1+R_2}$
	* Notamos que para que $Q_2$ conduzca, tenemmos que tener $V_{Q_2b}>V_{out}$ en el divisor de tension
	* $V_{Q_2b}=V_{in}\frac{R_2}{R_1+R_2}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY0ODY1MjM2LDg5MTkxODg2NiwtODM2ND
IyMTk1LDM3NzM3OTgsLTIzMTczMTM0OCwtNDI5NjQyODI3LC04
MDY3NDE5NjksLTEwODgyODMzNTYsLTExMjM2Mjg4MDYsNjY4NT
gyMjA4LDE2OTAzMzI5NDcsMjA0Nzk5NzUwNiw0ODExMTk5OTEs
LTQwMzkzNjk1NiwtMTYyMzI3MTM3OSwxMTcwMTY4OTgzLDE1MD
QwNjYxNjQsNTM4MDYwNjE5LDk2MDcwMDA5MCwtMTE0NTkyOTI0
OF19
-->