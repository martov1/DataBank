...
**DESVENTAJAS:**
* **BAJA PRECISION:** $v_{be}$ no siempre es $0.7V$ para toda , a mas $I_b$, mas caida de tension en $V_{be}$. esta va a variar entre los $0.3V \text{ y } 0.7V$. esto significa que: 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjYwMjc3NTA1XX0=
-->