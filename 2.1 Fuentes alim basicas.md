...
1.	Notamos que para que $Q_2$ conduzca, en su base debe haber una tension $V_{}$superior que la tension de ruptura del diodo de la base y del zener.
	*	 entonces $Q_2$ **conduce cuando**  $V_{bQ_2}>V_z+V_{be}$
2. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTU2NDU0MDAsODkxOTE4ODY2LC04Mz
