...
## Con transistor (Linear regulator)
...
**DESVENTAJAS:**
* **Ineficiente** al igual que su hermano la fuente de precision con OpAmp y transistor, El transistor (en este caso dentro del 7805) tiene que disipar toda la tension no utilizada por la fuente.
* **Consume mucho aun estando sin carga** cuando

### Configuracion de alta corriente -WIP
...
3. El regulador sigue fijando la tension de salida, por lo que el transisttor respeta esa tension, pero deja pasar corriente.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE3MDE2ODk4MywxNTA0MDY2MTY0LDUzOD
A2MDYxOSw5NjA3MDAwOTAsLTExNDU5MjkyNDgsMTA1NzczODY4
NCw4NTA2MjE4NTcsLTIxMDUxOTUxNTgsMTQ4OTAzNDI0OCw2Nj
AyNzc1MDVdfQ==
-->