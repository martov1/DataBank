...
Si son iguales, y **omitimos la constante C** entonces
![](https://i.imgur.com/Bbhuycz.png)
Lo que una funcion sube, la otra lo desciende en el mismo valor
![](https://i.imgur.com/oV9M0Xh.png)_recordemos que aunque aparezcan en el mismo grafico, son funciones diferentes, la de ascenso en $i(T*D)$ tiene un valor **positivo** mientras que la de descenso en  $i(_{(1-D)*T})$_
**Entonces:**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1MDI0MTk2OSwtMTU0NTg5NDUzOCw0Mj
