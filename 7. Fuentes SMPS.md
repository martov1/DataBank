...
Llamamos _charge balanced_ a un capacitor que se encuentra en un circuito en steay state, es decir que **en cada ciclo su tension vuelve al mismo valor.**
...
**Recordamos** Que matematicamente la equacion del capacitor es la siguiente

$$\boxed{ i(t) =C\frac{dV(t)}{dt}}$$

Vemos la corriente al principio de cada ciclo ($T=0$) y al final ($T=t$)

![](https://i.imgur.com/fKUrJCR.png)
Si integramos frente a ese periodo
...
**Como estamos en steady state**, el cambio de la tension en el capacitor,  es $\Delta V=0$
...
Entonces en steady state, la carga total del capacitor no cambia de un ciclo al otro. Entonces ademas el **promedio de la corriente que circula por el capacitor en un ciclo es**  $0$
...
### Inductor Volt-Second balance  - WIP
https://www.youtube.com/watch?v=_o-C3JlQ_W4&list=PLmK1EnKxphinxBub5hL0ZoJXWoqjkGE19&index=27


Llamamos _Volt-second valanced_ a un inductor que se encuentra en un circuito en steady state, es decir que **en cada ciclo su corriente   vuelve al mismo valor.**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjc3NTc4Mzc1LDEwNjU0MTk4MDEsLTExOD
k4MzUzMjksNTI5NDEyMzkzLC0xMzk5MDE3NTkzLDE5OTg2NTU3
MTQsMTM1NTU2MTEyNyw2NjU2MzUyMjUsLTUwOTIxNDE4NCwyMD
c0Mjg1OTIyLC0xMDg4ODQyMTI0LC0xODMwODcwODczLDE1NTU5
MzkyMDMsLTE1MjI2MjYwNTksLTg1NDM3NjE0NywtMTU2MzY4MD
EyNiw4NjI0MTQ0MDQsLTYyNzAwODI2MywtMjA5NjUwNDMxMSwy
ODM4MzA3NzBdfQ==
-->