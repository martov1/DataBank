...
$$D_2=\frac{V_{in}-V_{out}}{V_{out}}D_1$$
$$D_2=\frac{V_{in}}{V_{out}}\frac{-\cancel{V_{out}}}{\cancel{V_{out}}}D_1$$
$$\boxed{D_2=\frac{-V_{in}}{V_{out}}D_1}$$
...
$$\boxed{i_{outavg}=(D_1+D_2)(V_{in}-V_{out})\frac{D_1T}{L2}}$$

**Recordando**
que conocemos como calcular $D_2$

$$\boxed{D_2=\frac{-V_{in}}{V_{out}}D_1}$$


Reemplazando
$i_{outavg}=(D_1+\frac{-V_{in}}{V_{out}}D_1)(V_{in}-V_{out})\frac{D_1T}{L2}$

factor comun $D_1$ y agrupacion
$i_{outavg}=(1+\frac{-V_{in}}{V_{out}})(V_{in}-V_{out})\frac{D_1^2T}{L2}$

$i_{outavg}=((V_{in}-V_{out})+\frac{(V_{in}-V_{out})(-V_{in})}{V_{out}})\frac{D_1^2T}{L2}$

$i_{outavg}=((V_{in}-V_{out})+-V_{in}\frac{-V_{out}}{V_{out}}\frac{V_{in}}{V_{out}})\frac{D_1^2T}{L2}$

$i_{outavg}=((V_{in}-V_{out})+(-V_{in})(-1)\frac{V_{in}}{V_{out}})\frac{D_1^2T}{L2}$



$i_{outavg}=((V_{in}-V_{out})+\cancel{(-1)}\cancel{(-1)}\frac{V_{in}^2}{V_{out}})\frac{D_1^2T}{L2}$

$i_{outavg}=(V_{in}-V_{out}+\frac{V_{in}^2}{V_{out}})\frac{D_1^2T}{L2}$


$i_{outavg}=V_{in}(-V_{out}+\frac{V_{in}}{V_{out}})\frac{D_1^2T}{L2}$


$i_{outavg}=V_{in}V_{out}(-1+\frac{V_{in}}{V_{out}^2})\frac{D_1^2T}{L2}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjc1NDMwMjcyLDU0MjY1NTQ4NywtMTA5NT
I5NTY5MSwtMzA0NDgxMzU5LDI1MzYzODY3NSwtOTQ5OTY3NTAx
LDYwMjI1MjkyNywxODYwNjk5MjYyLDEwNzA3NzE4MzIsMTY0MT
E3NDkwMCw3MzY4ODY4NzksLTI2NDI3MTY3NywtMTQ5NDIyNTcx
OSwxMDE4MzQ4ODAxLC00NzgxMTQxMDcsLTEwMTE1MzM2NCwtMT
Y4NjA2OTc4NywtMTYyNDU3MTU1NywtMjYxMzQ4Njc3LDEzMjQ3
MTMzNDRdfQ==
-->