...
### Inductancia minima para CCM y $L_{crit}$ 
...
1. Es trivial ver que el ripple no esta montado a ninguna otra corriente (por que $i_{min}=0$) entonces
...
Obtengamos el promedio durante **la fase de conduccion**, es decir $D_1$ y $D_2$.
Usando la equacion $(2)$ anterior, sabemos que el cambio de la corriente $\Delta i$ es
...
Aplicando en la equacion $(2)$ obtengo

$$i_{\text{avg en conduccion}} =\frac{V_{in}-V_{out}}{L}D_1T$$

![](https://i.imgur.com/oC2tw9K.png)
**Entonces:**
Esa corriente $i_{\text{avg en conduccion}}$ es **toda la corriente que hay**, y va a ser absorbida en parte por el capacitor y repartida en el periodo $D_3$.
 
Eso significa que la corriente promedio en los tres periodos va a ser:
$I_\text{avg en conduccion}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjIwNjE4OTQsNTU0Mjg2MDcxLDYwOD
czMTY2LDk1NDQyNDYzMiwtMTYyODQ3NzEwNiwxMzk1Mjk1Mzcz
LC0xMzgzNTY2NjI5LDEyMzM3OTcyOCwtOTk3NTMyNjE4LDE1Nz
k1NzQ0MDQsLTE4MjY2MzA4MDUsLTE3MTQ3MzYxOTUsLTE5NzQw
NDMzMzEsLTE3ODg3NDkxNzMsMzA5MDg3OTA1LDEwNTEzMzE4MT
csLTE3NzM1MTkwNzIsLTE0MDE3NjI2ODgsLTEwODY3MTY4NTgs
LTIxMjQxNTQ2MzFdfQ==
-->