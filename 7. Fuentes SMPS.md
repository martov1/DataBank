...
**Notamos que:**
En nuestra nueva situacion, el ripple se puede calcular de la misma manera pero los intervalos de tiempo cambiaron
* $D*T$ es ahoa $D_1*T$
* $(1-D)*T$ es ahora $D_2*3$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMjg3MTkxMzEsMTM5NTI5NTM3MywtMT
