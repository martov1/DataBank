...
Recordemos el comportamiento de la corriente de un inductor y un resistor en DC
	 ![](https://i.imgur.com/MCAxz0I.png =400x)
	
Ahora, si "chopearamos" la tension DC, y permitieramos al inductor descargarse en cada "chop", llegariamos a un equilibrio por debajo del  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3Mjk2NDczODYsMTAzMDYxMDQwMCwxNT
Y1MTgwMjUxLDI3OTc3NTg5OSwtODY0MTIwNzEwLC0xMTM1Mjgy
ODg2LDcwOTEyMzAyMywtNTk4NzA2ODMsLTQ5MjU3NjQyNCwxMD
