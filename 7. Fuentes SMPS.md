...
**CONCLUSION:**
Si estoy en  steady state, es decir la tension del capacitor en $T=0$ y $T=t$ no cambia, es decir $\Delta V=0$
...
>* $\int_0^t{V(t)} = \Delta V$ es el cambio de la tension en el capacitor.
...
Entonces en steady state, no hay cambio de tension entre un ciclo y el que sigue
$$\Delta V =0$$

**CONCLUSION:**
En steady state, es decir cuando la corriente tiene el mismo valor al comienzo y al final del ciclo (en $T=0$ es igual a la corriente en $T=t$:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDY2Mjg1ODcsMjA0OTMxNzU5LC03NT
U4NTA0ODgsLTU1ODIyMDk4Niw2Nzc1NzgzNzUsMTA2NTQxOTgw
MSwtMTE4OTgzNTMyOSw1Mjk0MTIzOTMsLTEzOTkwMTc1OTMsMT
