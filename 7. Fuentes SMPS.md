...
3. Asi entonces sabemos **la corriente** a lo largo del tiempo cuando **el transistor esta conduciendo**
$$\boxed{i(t)=\frac{V_{in}-V_{out}}{L}t}$$ 
4. La corriente maxima se da en **el instante en el que el transistor dejaa de co**  cuando el transistor deja de conducir
...
3.  Resolviendo la equacion diferencial para obtener $i(_{(1-D)*T})$
$$\int_0^{(1-D)*T}\frac{di(t)}{dt}=\int_0^{(1-D)*T}\frac{-V_{out}}{L}$$
Como son todas constantes
$$\boxed{i(_{(1-D)*T})=\frac{-V_{out}}{L}*(1-D)*T}$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4Mjg2MzU5NzQsMjYyMDAwMzUsMTUyND
