...
[fuente](https://www.youtube.com/watch?v=PedoHWu_olI&list=PLmK1EnKxphinxBub5hL0ZoJXWoqjkGE19&index=27)
[fuente](https://www.youtube.com/watch?v=PedoHWu_olI&list=PLmK1EnKxphinxBub5hL0ZoJXWoqjkGE19&index=27)
Quiero encontrar la corriente pico $i_{min}$ que ocurre en  $i(_{(1-D)*T})$ ya que el momento $(1-D)*T$ es cuando el transistor pasa de ON a OFF
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE3NzgzNTA3NCwxODEzOTEyNzU5LC02Mj
EyMTUwNSwxNzQwNDcyMzk0LDE3MDUwMjQxNzAsLTIwNDI4MTY1
MTgsMTM4MjE0ODE3NSw3ODA3MDM5NDcsNDYzODk2ODcsMTE3OD
