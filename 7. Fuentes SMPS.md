...
### Deduccion del duty cycle

**Recordamos** que conocemos las equaciones para $i_{max}$ y $i_{min}$ 
...
**Notamos**
Que en la equacion $(1)$
* $i_{min}=0$ por que arrancamos sin corriente por el inductor
* Cuando $t=T*D_1$ entonces  obtendremos $i_{max}$
$$(1) \quad i(T*D)=\frac{V_{in}-V_{out}}{L}*T*D_1 + 0$$
$$i_{max}=\frac{V_{in}-V_{out}}{L}*T*D_1$$

De la misma manera, notamos que en la equacion $(2)$ podemos 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE5MjA0NzQ1NCwxMzk1Mjk1MzczLC0xMz
gzNTY2NjI5LDEyMzM3OTcyOCwtOTk3NTMyNjE4LDE1Nzk1NzQ0
MDQsLTE4MjY2MzA4MDUsLTE3MTQ3MzYxOTUsLTE5NzQwNDMzMz
EsLTE3ODg3NDkxNzMsMzA5MDg3OTA1LDEwNTEzMzE4MTcsLTE3
NzM1MTkwNzIsLTE0MDE3NjI2ODgsLTEwODY3MTY4NTgsLTIxMj
QxNTQ2MzEsMTI2NzcyOTkzNCwtMTA1MjM5MDM3NCwtMjgxMDE3
NTEwLC0xOTQ2MDE5MzE1XX0=
-->