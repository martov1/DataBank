...
Recordemos el comportamiento de la corriente de un inductor y un resistor en DC. vemos que **eventualmente** el inductor se carga totalmente y la corriente pasa solamente restringida por la ley de oh de
	 ![](https://i.imgur.com/MCAxz0I.png =400x)
	
Ahora, si "chopearamos" la tension DC, y permitieramos al inductor descargarse en cada "chop", llegariamos a un equilibrio por debajo de la corriente
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY3MDUzMzU4MywxMDMwNjEwNDAwLDE1Nj
UxODAyNTEsMjc5Nzc1ODk5LC04NjQxMjA3MTAsLTExMzUyODI4
ODYsNzA5MTIzMDIzLC01OTg3MDY4MywtNDkyNTc2NDI0LDEwND
