...
### Relacion $D_1$-$V_{out}$ - $V_{in}$ - $R_{load}$
[fuente](https://www.allaboutcircuits.com/technical-articles/discontinuous-conduction-mode-of-simple-converters/)
...
$$D_1=\sqrt{\frac{V_{out}^2L2}{R_{load}(V_{in})(V_{in}-V_{out})D_1^2T}}$$

$$D_1=V_{out}\sqrt{\frac{L2}{R_{load}(V_{in})(V_{in}-V_{out})D_1^2T}}$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzY1NjIxOTIzLDc2OTU2NjM4NSwtMTE1Mz
cyNTk1NiwtNDU5NzAyMDgsODk2MzE1MjUzLC0zODQ0MzQ1NzAs
LTk2OTA1MjMwOSwtMTM0NTEyNjk4NiwtMTAzNjc4Mzg2NCwtMT
U3MDMyNDM5OSwxNTE4MDYxNDEsNTQyNjU1NDg3LC0xMDk1Mjk1
NjkxLC0zMDQ0ODEzNTksMjUzNjM4Njc1LC05NDk5Njc1MDEsNj
AyMjUyOTI3LDE4NjA2OTkyNjIsMTA3MDc3MTgzMiwxNjQxMTc0
OTAwXX0=
-->