...
### El Duty cycle, $V_{in}$ y $V_{out}$ - WIP
...
Imaginemos ahora que estamos en **CCM** y llegamos al steady state y el ciclo dura un **tiempo total** $T$ antes de repetirse
...
>La tension que hay entre los bornes del inductor $V_L$ es 
>* La tension que me da la fuente $V_{in}$ (por que en $T_{on}$ el transistor conduce) 
>* y que no esta cayendo en la resistencia $V_{out}$
>$V_L=V_{in}-V_{out}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcxOTY5ODcxNCwtMjA1MTU3MDgwOSwxOT
...
NTksLTc1NTg1MDQ4OCwtNTU4MjIwOTg2LDY3NzU3ODM3NSwxMD
Y1NDE5ODAxLC0xMTg5ODM1MzI5LDUyOTQxMjM5MywtMTM5OTAx
NzU5M119
-->