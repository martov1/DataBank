...
$$(1) \quad i_{max} =\frac{-V_{out}}{L}D_2T$$
...
$$i_{avg}=\frac{1}{T-0}(\frac{1}{2}*(D_1+D_2)T*i_{max})$$

$$(1)  \quad \boxed{i_{avg}=\frac{(D_1+D_2)Ti_{max}}{2}}$$

**Recordando que**
* En este caso $\Delta i = i_{max}$ ya que  $i_{min}=0$
*  sabemos que en **DCM** se cuple que
	* $(2) \quad \Delta i =\frac{V_{in}-V_{out}}{L}D_1T$
* osea que
	* $(2) \quad i_{max}=\frac{V_{in}-V_{out}}{L}D_1T$

**Entonces:**
Reemplazando $(1)$ y $(2)$
$\boxed{i_{avg}=\frac{(D_1+D_2)Ti_{max}}{2}}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUwNTY0MjAxMiwxMDcwNzcxODMyLDE2ND
...
NzEzMzQ0LDY0Njk5MTM5LC0yMTcyNjI3NywtMTgyODkyNTA1Mi
wxOTM1MTAwNjkxLDU1NDI4NjA3MSw2MDg3MzE2Niw5NTQ0MjQ2
MzJdfQ==
-->