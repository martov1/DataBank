...
* **CCM - Continious conduction mode** En el que 
	...
	* El "exceso de energia" que provoca la tension alta de la fuente se guarda en campo magnetico en el inductse puede "esparcir en el tiempo" en una tension mas pequeña sin perder energia en forma de calor
* **DCM - Discontinious conduction mode** En el que el inductor deja de proveer energia cuando el transistor esta en OFF.
	* En este modo quien provee la corriente es el capacitor. 
	* La energia se "esparce en el tiempo" con la misma idea, pero el capacitor es 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU2MTQwMTM3MSwtODU0Mzc2MTQ3LC0xNT
