...
**Notamos que:**
La **cantidad de carga** $Q$ que el capacitor debe **absorver** (en verde) o **liberar** (en celeste) es la misma, y que ademas podemos calcularla con **el area de esos triangulos**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM1ODE1OTQyOCwxNTIyMzk1NjcsMTcwNT
