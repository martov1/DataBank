...
o que 
$$D=\frac{T_{off}-T_{on}}{T}$$

o mas facilmente, podemos indicar el duty cycle como un numero entre 0 y uno asi
...
1. Cuando se termina $T_{on}$, en $T*D_{uty cycle}$
2. Cuando se termina $T_{off}$, en $T$

**1) Cuando se termina** $T_{on}$
Usando la equacion del inductor
$$\frac{di}{dt}=\frac{V_L}{L}$$ 

>La tension que hay entre los bornes del inductor $V_L$ cuando el transistor conduce,  por  KVL es
>$V_L=V_{in}-V_{out}$
...
Despejando la equacion diferencial integrando de ambos lados
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDU3MDYyMzcyLC0xNjg4OTk3NDY3LC00OT
IzODUwNjQsLTcxOTY5ODcxNCwtMjA1MTU3MDgwOSwxOTYyNzU1
Njc1LDEwMzA2MTA0MDAsMTU2NTE4MDI1MSwyNzk3NzU4OTksLT
g2NDEyMDcxMCwtMTEzNTI4Mjg4Niw3MDkxMjMwMjMsLTU5ODcw
NjgzLC00OTI1NzY0MjQsMTA0MzE0MTQwNCwyMDQ5MzE3NTksLT
c1NTg1MDQ4OCwtNTU4MjIwOTg2LDY3NzU3ODM3NSwxMDY1NDE5
ODAxXX0=
-->