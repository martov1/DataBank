...
* La corriente de un inductor en DC
	* ![](https://i.imgur.com/fX6WNkh.png =200x)
* La corriente de un inductor y un resistor en DC
	* ![](https://i.imgur.com/MCAxz0I.png =250x)
ahora, si "chopearamos" la tension DC, 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg2MDYwNTA0MiwxMDMwNjEwNDAwLDE1Nj
