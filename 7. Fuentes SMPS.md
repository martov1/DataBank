...
## Derivacion de equacion de Duty cycle - WIP
...
Si son iguales, y **omitimos la constante C** entonces lo que una funcion sube, la otra lo desciende en el mismo valor
![](https://i.imgur.com/oV9M0Xh.png =400x)_recordemos que aunque aparezcan en el mismo grafico, son funciones diferentes, la de ascenso en $i(T*D)$ tiene un valor **positivo** mientras que la de descenso en  $i(_{(1-D)*T})$ tiene un valor **negativo** pero **de la misma magnitud**_
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4ODcyOTY0OCwtMTU0NTg5NDUzOCw0Mj
c3ODM4OCwxNjM1NjA5ODMyLC0zMjMzNjgwOTksLTg5NjUzNzA0
NiwxNTYwNjA2MjgsLTEyNzEzMTY2NzksMjYyMDAwMzUsMTUyND
EwMDYzMiwtMTA0MTYyMzY2MiwtOTY0ODk3MDIzLDExNzc4MzUw
NzQsMTgxMzkxMjc1OSwtNjIxMjE1MDUsMTc0MDQ3MjM5NCwxNz
A1MDI0MTcwLC0yMDQyODE2NTE4LDEzODIxNDgxNzUsNzgwNzAz
OTQ3XX0=
-->