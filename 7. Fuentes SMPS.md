...
* **CCM - Continious conduction mode** En el que el inductor provee la tension a la carga cuando el transistor esta en OFF, de esta forma el "exceso de energia" que provoca la tension alta de la fuente se puede "esparcir en el tiempo" en una tension mas pequeña sin perder energia en forma de calor
* **DCM - Discontinious conduction mode** En el que el inductor dej
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxNDA4NjE2MzUsLTg1NDM3NjE0NywtMT
