...
### Introduccion al funcionamiento de potencia
...
> *Los transistores en ON o OFF (idealmente) 
...
* **CCM - Continious conduction mode** En el que 
	...
	* El "exceso de energia" que provoca la tension alta de la fuente se guarda en campo magnetico en el inductor y se libera cuando el transistor esta en OFF. 
		* De esta forma la energia se puede "esparcir en el tiempo" con una tension mas pequeña sin perder energia en forma de calor
* **DCM - Discontinious conduction mode** En el que 
	* El inductor deja de proveer energia cuando el transistor esta en OFF.
	* En este modo quien provee la corriente es el capacitor. 
	* La energia se "esparce en el tiempo" con la misma idea, pero el capacitor es el dispositivo de almacenamiento.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYwMDQ3MDQxNSwtODU0Mzc2MTQ3LC0xNT
YzNjgwMTI2LDg2MjQxNDQwNCwtNjI3MDA4MjYzLC0yMDk2NTA0
MzExLDI4MzgzMDc3MCwtNjk1MDMyMzk3LC0xMTk2NjgzMzcwLD
MyMTkwMjY5NiwtNTAzODM1OTQ5LC0zODkzNDQ1NzcsLTEwNzQ1
ODY4MjEsOTAyMDAwNjg5LC0xMDA4NDM2MTgwLDE5MzI2NzI1Nj
IsMTYwMjgyMTA1OSwxNjcxMTAwMzEwLC02NzI3ODI5NjgsMTMy
MzAyNjEzOF19
-->