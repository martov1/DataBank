...
$$\boxed{D_2=\frac{V_{in}}{V_{out}}\frac{-\cancel{V_{out}}}{V_{out}}D_1}$$
>**Ademas**
...
$i_{outavg}=D_1(1+\frac{V_{in}-V_{out}}{V_{out}})(V_{in}-V_{out})\frac{D_1T}{L2}$

$i_{outavg}=(1+\frac{V_{in}-V_{out}}{V_{out}})(V_{in}-V_{out})\frac{D_1^2T}{L2}$

$i_{outavg}=((V_{in}-V_{out})+\frac{(V_{in}-V_{out})^2}{V_{out}})\frac{D_1^2T}{L2}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg5NDIyNzgzMywtMzA0NDgxMzU5LDI1Mz
YzODY3NSwtOTQ5OTY3NTAxLDYwMjI1MjkyNywxODYwNjk5MjYy
LDEwNzA3NzE4MzIsMTY0MTE3NDkwMCw3MzY4ODY4NzksLTI2ND
I3MTY3NywtMTQ5NDIyNTcxOSwxMDE4MzQ4ODAxLC00NzgxMTQx
MDcsLTEwMTE1MzM2NCwtMTY4NjA2OTc4NywtMTYyNDU3MTU1Ny
wtMjYxMzQ4Njc3LDEzMjQ3MTMzNDQsNjQ2OTkxMzksLTIxNzI2
Mjc3XX0=
-->