...
Podemos calcular los momentos de encendido y apagado
$$\boxed{T_{off}=T_{on}+D*T}$$
...
**Calculemos el valor de la corriente:**
1. Cuando el transistor se apaga, en $T*D_{uty cycle}$
2. Cuando el transistor se vuelve a prender, en $T$

![](https://i.imgur.com/34ehn4z.png)
#### Corriente $i_{max}$

Quiero encontrar la corriente pico $i_{max}$ que ocurre en  $i(T*D)$
![](https://i.imgur.com/ijU01nk.png)
**1) Cuando el transistor estaba encendido y se apaga**
Usando la equacion del inductor
...
>* $L$ **es constante**
>
>$$\int_0^{T*D_{uty cycle}}{\frac{di(t)}{dt}}=\int_0^{T*D_{uty cycle}}{\frac{V_{in}-V_{out}}{L}}$$ 
>Integrando
$$\boxed{i(T*D_{uty cycle})=\frac{V_{in}-V_{out}}{L}*T*D_{uty cycle}}$$ 

Asi entonces sabemos **la corriente maxima, que ocurre apenas se desconecta el transistor**
$$\boxed{i(T*D_{uty cycle})=\frac{V_{in}-V_{out}}{L}*T*D_{uty cycle}}$$ 
![](https://i.imgur.com/ijU01nk.png)

#### Corriente $i_{min}$ - WIP
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk3MzM2NDQ1NCw3ODA3MDM5NDcsNDYzOD
k2ODcsMTE3ODA3NzYyLC0xNDg0NjM0MTYwLDEwMzQyNzY2Nzcs
LTE2ODg5OTc0NjcsLTQ5MjM4NTA2NCwtNzE5Njk4NzE0LC0yMD
UxNTcwODA5LDE5NjI3NTU2NzUsMTAzMDYxMDQwMCwxNTY1MTgw
MjUxLDI3OTc3NTg5OSwtODY0MTIwNzEwLC0xMTM1MjgyODg2LD
cwOTEyMzAyMywtNTk4NzA2ODMsLTQ5MjU3NjQyNCwxMDQzMTQx
NDA0XX0=
-->