...
> la constante $C$ de integracion le decimos $i_{min}$ por que cuando $t=0$ estamos en el punto donde la corriente es minima, ya que acabamos de conectar el 
3. Asi entonces sabemos que **la funcion que domina la corriente ascendente es**
$$\boxed{i(t)=\frac{V_{in}-V_{out}}{L}t}$$ 
...
$$\boxed{i_{max}=\frac{V_{in}-V_{out}}{L}*T*D + i_{inicial}}$$ 
_podemos o no ignorar la corriente inicial $+ i_{inicial}$ depende de que estemos haciendo_
...
$$\boxed{i(t)=\frac{-V_{out}}{L}*t + i_{inicial}}$$
_podemos ignorar $i_{inicial}$ dependiendo de que estemos haciendo_
...
$$\boxed{i_{min}=i(_{(1-D)*T})=\frac{-V_{out}}{L}*(1-D)*T}$$
...
Conocemos las dos equaciones que dominan la corriente del inductor cuando **el transistor conmuta** $(1)$  y cuando el transistor  **no conmuta** $(2)$

* $(1) \quad \boxed{i(t)=\frac{V_{in}-V_{out}}{L}*t}$

* $(2) \quad \boxed{i(t)=\frac{-V_{out}}{L}*t}$
...
![](https://i.imgur.com/oV9M0Xh.png =400x)_Recordemos que aunque aparezcan en el mismo grafico, **son dos funciones diferentes**, la de ascenso en $i(T*D)$ tiene un valor **positivo** mientras que la de descenso en  $i(_{(1-D)*T})$ tiene un valor **negativo** pero **de la misma magnitud**_
...
## Diseño y calculo en CCM
https://www.youtube.com/watch?v=Uu_sJmlUFVE&t=2041s
https://www.youtube.com/watch?v=tMJRwq8CWeI&t=155s
### Seleccion del inductor - WIP
https://www.youtube.com/watch?v=aJ-sGbjwjhA&list=PLmK1EnKxphinxBub5hL0ZoJXWoqjkGE19&index=29

Vamos a tener que asumir algunas cosas
* $V_{in}$ la tension de entrada
* $V_{out}$ la tension de salida promedio
* $i_{out}$ la corriente de salida deseada
* 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NjQ0OTQyODYsNTIyODUyNzQ0LC0yMD
E3MzQwMzk2LC01NjM3ODgwOTUsLTEzMDE1OTgyNzEsMzUwMjUw
NzcsMjE0MzkwNTUyNSwtMTU0NTg5NDUzOCw0Mjc3ODM4OCwxNj
M1NjA5ODMyLC0zMjMzNjgwOTksLTg5NjUzNzA0NiwxNTYwNjA2
MjgsLTEyNzEzMTY2NzksMjYyMDAwMzUsMTUyNDEwMDYzMiwtMT
A0MTYyMzY2MiwtOTY0ODk3MDIzLDExNzc4MzUwNzQsMTgxMzkx
Mjc1OV19
-->