...
**Entonces:**
Reemplazando $(1)$ y $(2)$
$i_{avg}=\frac{(D_1+D_2)T(\frac{V_{in}-V_{out}}{L}D_1T)}{2}$
re acomodando
$i_{avg}=\frac{(D_1+D_2)T(V_{in}-V_{out}D_1T)}{2L}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUxMDU0NDI5LDE4NjA2OTkyNjIsMTA3MD
c3MTgzMiwxNjQxMTc0OTAwLDczNjg4Njg3OSwtMjY0MjcxNjc3
LC0xNDk0MjI1NzE5LDEwMTgzNDg4MDEsLTQ3ODExNDEwNywtMT
AxMTUzMzY0LC0xNjg2MDY5Nzg3LC0xNjI0NTcxNTU3LC0yNjEz
NDg2NzcsMTMyNDcxMzM0NCw2NDY5OTEzOSwtMjE3MjYyNzcsLT
E4Mjg5MjUwNTIsMTkzNTEwMDY5MSw1NTQyODYwNzEsNjA4NzMx
NjZdfQ==
-->