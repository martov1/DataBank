...
**Entonces** el promedio **durante la fase de conduccion**, es decir, en los duty cycles $D_1$ y $D_2$, es $\frac{\Delta i}{2}$, ya  que es un triangulo.
Aplicando esto en $(2)$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA5ODU5MTYxMCw1NTQyODYwNzEsNjA4Nz
