...
2. como los triangulos son iguales (misma altura y misma area implica misma base) entonces:

 **sus bases miden** $\frac{T}{2}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk1ODE5NTY4MSwxNzA1NDE0ODczLDEwMj
