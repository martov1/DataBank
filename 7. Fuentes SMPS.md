...
$$(1) \quad  \boxed{i_{max}=\frac{V_{in}-V_{out}}{L}*T*D + i_{min}}$$ 

$$(2) \quad \boxed{i_{min}=\frac{-V_{out}}{L}*(1-D)*T+i_{max}}$$

**Notamos**
Que  en el caso de **DCM**
$D_1=T*D$, pero$D_2 \neq (1-D)*T$   


$(1) \quad i(t)=\frac{V_{in}-V_{out}}{L}*t$
$(2) \quad i(t)=\frac{-V_{out}}{L}*t+ i_{max}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0Mjk4MTQ2NTcsMTM5NTI5NTM3MywtMT
