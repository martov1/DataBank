...
### Corriente promedio del ripple


![](https://i.imgur.com/ebz5vZP.png =400x)

Podemos calcular el promedio del ripple $\Delta i(t)$, esto seria $i(t)$ **sin su componente DC**, o fingiendo que su componente DC es zeo
...
**Recordamos** que el promedio de funcion es
 ...
 $i_{rippleavg}=\frac{1}{T-0}\int_0^T{\Delta i(t)}$

 Esa integral obviamente es el area de triangulo, donde la base es 
$T$ y la altura es $\Delta i$ o $i_{max}$
...
### Corriente promedio en el limite 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzYzOTk5NjksLTEwMTE1MzM2NCwtMTY4Nj
A2OTc4NywtMTYyNDU3MTU1NywtMjYxMzQ4Njc3LDEzMjQ3MTMz
NDQsNjQ2OTkxMzksLTIxNzI2Mjc3LC0xODI4OTI1MDUyLDE5Mz
UxMDA2OTEsNTU0Mjg2MDcxLDYwODczMTY2LDk1NDQyNDYzMiwt
MTYyODQ3NzEwNiwxMzk1Mjk1MzczLC0xMzgzNTY2NjI5LDEyMz
M3OTcyOCwtOTk3NTMyNjE4LDE1Nzk1NzQ0MDQsLTE4MjY2MzA4
MDVdfQ==
-->