...
$$\int_0^t{i(t)} =\int_0^t{C\frac{dV(t)}{dt}}$$


$$\int_0^t{i(t)} =C\int_0^t{\frac{dV(t)}{dt}}$$

Recordamos que la integral de la corriente es el cambio de la carga $Q$ del capacitor, **como estamos en charge valance, ese valor no cambia**.

$\Delta Q =C (V(t)-V(0))$

$0=C (V(t)-V(0))$
 
 **Entonces** la tension en el principio y fin del periodo debe ser igual
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzY2MDc0MjY2LDUyOTQxMjM5MywtMTM5OT
AxNzU5MywxOTk4NjU1NzE0LDEzNTU1NjExMjcsNjY1NjM1MjI1
LC01MDkyMTQxODQsMjA3NDI4NTkyMiwtMTA4ODg0MjEyNCwtMT
gzMDg3MDg3MywxNTU1OTM5MjAzLC0xNTIyNjI2MDU5LC04NTQz
NzYxNDcsLTE1NjM2ODAxMjYsODYyNDE0NDA0LC02MjcwMDgyNj
MsLTIwOTY1MDQzMTEsMjgzODMwNzcwLC02OTUwMzIzOTcsLTEx
OTY2ODMzNzBdfQ==
-->