...
Queremos eliminar el ripple en la salida de la fuente
...
* Se va a cargar un poco mas cuando haya mas corriente saliendo del inductor
	* Cuando la corriente este encima del promedio
* Se va a descargar cuando la corriente del inductor disminuya. 
	* Cuando la corriente este abajo del promedio


Es decir, el capacitor estara en **charge balance**

![](https://i.imgur.com/3Zi5kXn.png)

Tambien podemos pensarlo como que 
* Cuando **baje la corriente del inductor**, bajara la tension por la carga y el capacitor se decarga para evitar que baje la tension
* , cuando suba la corriente a traves del inductor, sube la tension de la carga y el capacitor se carga 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcxMDY2NTU0OCwtMTEyNzA5NjA5MCwtNj
MwNDg0NTMyLC0yMTQ0NDcyMTQ3LDExODA4NTQyMDQsNTIyODUy
NzQ0LC0yMDE3MzQwMzk2LC01NjM3ODgwOTUsLTEzMDE1OTgyNz
EsMzUwMjUwNzcsMjE0MzkwNTUyNSwtMTU0NTg5NDUzOCw0Mjc3
ODM4OCwxNjM1NjA5ODMyLC0zMjMzNjgwOTksLTg5NjUzNzA0Ni
wxNTYwNjA2MjgsLTEyNzEzMTY2NzksMjYyMDAwMzUsMTUyNDEw
MDYzMl19
-->