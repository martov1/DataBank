...
Cuando eso sucede **es como si el capacitor y el inductor no estuvieran**, es decir, **corre la misma corriente RMS **

Podemos calcular la resonancia en este circuito IRL en serie viendo cuando la impedancia del inductor es igual a la del capacitor.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkyNTA1ODI3MCwtNTc5MjI5NDIsLTk4Nj
