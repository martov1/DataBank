...
* Cuando el capacitor se **descarga**, hace fluir una corriente a traves de la bobina, generando un campo magnetico
* Cuando  el capacitor queda **totalmennte descargado**, el campo **magnetico del inductor colapsa**, haciendo que la corriente siga fluyendo en esa direccion
* La corriente imu
* 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI3MjMwODQ0MCwtMTkxMDE0MzQ2Myw4OT
