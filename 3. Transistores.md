...
Esto funciona **casi igual a la fuente de tensión independiente**, generamos una tensión conocida $B_{be}$ con un divisor de tensión y nos aseguramos de que la corriente que chupe el transistor $I_b$ sea mucho mas chica que la que pasa por todo el divisor de tensión, entonces no afecta el voltaje $V_{be}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5NzA2ODc5NSwtNjEzNjI4OTY1LC0xNT
U3NDA5NzEyLDI5NDQzMzE4NCw0Mjg3NzY1NTUsLTE3MTEyMzUw
NSwtMTAzMTI0OTc1OSwxMjQyNjQ1NDUsOTAwNzI1MTQyXX0=
-->