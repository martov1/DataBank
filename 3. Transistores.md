...
**Osea que $Z_{out}$ del emitter-follower es funcion de la impedancia de la señal de entrada.**

![](https://i.imgur.com/Q5N2R7G.png)
1. Imaginemos que sabemos la impedancia de la señal real de entrada que tiene esa señal que le estamos metiendo al emitter-follower

por ley de ohm sabemos que en su impedancia:
$$R_{source}=\frac{V_{rsource}}{I_{in}}$$

2. Cuando conectamos esa señal a nuestro emitter follower, tenemos otra corriente de salida $i_{out}$, y por ende una nueva impedancia $Z_{out}$ (que sera la del emitter follower)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MjMxODIwODEsLTE1NjgzMDAxNTYsMj
Y3OTM4MDY3LC0xMzg0MTI0NjUwLDI2OTI5Njk2MCw5NzQxNTUy
NjcsMjA1MDc3NDUzLC0xOTkwMzYyMDM5LC0xNzM3ODYzNTk2LC
03NzAyMDIzMjIsMTMxNTUwNDAxNCwtOTE0NDEyMjAsLTk4MTUx
NDg1NywxOTI4ODk5OTU3LC0xNTU5MzkwNzk2LDE5MzUxMzYzOT
csLTEwOTc0ODcwLDExMDg1NzA5MDQsLTEzMDgxMDMzMjUsMTYy
MTg1OTg2OV19
-->