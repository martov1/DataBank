...
1. sea positiva cuando llegue al transistor
2. Cuando salga del transistor le saquemos la parte positiva, para que sea AC de nuevo
3. Este encima de los $0.7v$



Para eso:
4.  Creamos una tension de referencia que alimente la base del emitter-follower con un  **voltage divider** usando $R_1$ y $R_2$
5. **Acoplamos** nuestra señal AC a esa tension de referencia con un **coupling capacitor**. 
6. El emitter follower copiara esa tension, pero ahora puede proveer la corriente que pueda darte el **voltage divider** (osea, mas que la señal original!)
7. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcwNjg2ODMzMCwtNzc2MDc1NTk1LDE2MT
