...
1. Generamos una tensión conocida $B_{be}$ con un divisor de tensión 
...
3. Listo, tenemos una corriente fija $I_e$ por que $V_{be}$ es fijo y determina la caida de tension en el resistor que viene despues del transistor $$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzk1Mjg5MTA0LC02MTM2Mjg5NjUsLTE1NT
c0MDk3MTIsMjk0NDMzMTg0LDQyODc3NjU1NSwtMTcxMTIzNTA1
LC0xMDMxMjQ5NzU5LDEyNDI2NDU0NSw5MDA3MjUxNDJdfQ==
-->