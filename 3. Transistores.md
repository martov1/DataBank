...
## 2. The emitter follower/common collector - WIP
...
### Impedancia del emitter-follower - WIP
...
**Entonces:** 
$$Z_{in} = \frac{V_{in}}{I_{in}}=\frac{V_b}{I_b}$$
![](https://i.imgur.com/Kf4j4Ps.png)

#### Impedancia de salida  $Z_{out}$ - WIP

Nuestro emitter-follower tiene una **fuente de tension ideal** (la de arriba) asi que puede proveer potencia infinita.

Entonces la corriente maxima que puede proveer va a depender de la impedanciade la señal de entrada, la corriente de salida recien va a caer cuando le pida mucha corriente a la señal de entrada.

![](https://i.imgur.com/8N0bFQW.png)

**Osea que $Z_{out}$ del emmitter follower es funcion de la impedancia de la señal de entrada.**

$$Z_{out}=\frac{V_{in}-V_{out}}{I_{out}}$$

Se que la tension de salida es la misma que la de entrada (aprox, cambia en $0.6v$)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExOTcwMTI1OSwtMTU2ODMwMDE1NiwyNj
c5MzgwNjcsLTEzODQxMjQ2NTAsMjY5Mjk2OTYwLDk3NDE1NTI2
NywyMDUwNzc0NTMsLTE5OTAzNjIwMzksLTE3Mzc4NjM1OTYsLT
c3MDIwMjMyMiwxMzE1NTA0MDE0LC05MTQ0MTIyMCwtOTgxNTE0
ODU3LDE5Mjg4OTk5NTcsLTE1NTkzOTA3OTYsMTkzNTEzNjM5Ny
wtMTA5NzQ4NzAsMTEwODU3MDkwNCwtMTMwODEwMzMyNSwxNjIx
ODU5ODY5XX0=
-->