...
De forma muy similar a ejemplos pasados, usamos **resistores de biasing** $R_1$ y $R_2$ para generar una tension $V_e$ conocida en el emisor y un resistor conocido en el emisor $R_e$



[ejemplo](https://tinyurl.com/y2mqums2)
![](https://i.imgur.com/0W0sKON.png)
### Con diodo zener
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyMTc4OTE5MywtNTc1ODkyMjc2LC0yMD
