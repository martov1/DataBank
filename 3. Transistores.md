...
Estas caracteristicas pueden evidenciarse en el **grafico caracteristico de un transistor**. Este grafico suele estar en el **data sheet** de cada modelo de transistor, y muestra **para diferentes corrientes de base** $I_b$ 
![](https://i.imgur.com/riXEyso.png =500x) 
## Load line, Q-point y amplificacion
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MzIyMzY2MTEsLTcyNTA4NjU4NSwtMT
