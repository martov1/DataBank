* Terminar de ver https://www.youtube.com/watch?v=oF_VDtF7ptg
* Implementar load line en todas las configuraciones de transistores
* Separar load-line de amplificacion
...
* Si **nuestro transistor esta _en reposo_** con un $I_b$ puntual, entonces 
	* Cuando se _lo perturbe_ con **cambios de corriente de base** $\Delta I_b$ podremos ver la **amplificacion** de esos cambios en el **voltaje amplificado**  y en la **corriente amplificada**
* A ese punto de _reposo_ en nuestro sistema de amplificacion le decimos **Q-point** ó **Operation point**

## Amplificacion - WIP
* separar amplificacion de load line, cambiar la imagen colocada.
* Añadir load line a los ejemplos de biasing

## Trabajo en ZONA ACTIVA - WIP
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMjQzNDk2NzMsLTcyNTA4NjU4NSwtMT
U4MTA2MTcyOCwtMTg3MjUxMTY0OSwtNDM0NzcwMDUwLC0xODEx
NDYwNjc4LDI3NDMyOTQ3NywyMjU2NjEwMDcsODEwNTI5MDk0LC
0xMjcxODMwNDYwLDk5MjEyOTAwNCw5MDk4MTQ4MDIsLTYxMzYy
ODk2NSwtMTU1NzQwOTcxMiwyOTQ0MzMxODQsNDI4Nzc2NTU1LC
0xNzExMjM1MDUsLTEwMzEyNDk3NTksMTI0MjY0NTQ1LDkwMDcy
NTE0Ml19
-->