...
Podemos usar nuestro emitter-follower para **reducir la impedancia de una señal AC**, para hacerlo tenemos que tener en cuenta algunas cosas
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyOTc0NjIxNTIsLTEyOTA5MDgxNTcsMT
