...
1. Definimos la carga maxima $R_e$ que queremos alimentar. EJ: $2K\Omega$ o menos
...
4. Definimos $V_{cc}$ **minimo**  necesario para el compliance deseado, sabiendo que se debe cumlir que $V_{ce}>0.3$.
	5. aplicando KVL $V_{cc}=V_{carga}+V_{R_e}+0.3$
	6. $V_e$ ya lo habiamos definido, completando me queda que  $V_{cc}=V_{carga}+1+0.3$
	7. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNjA3NzA3ODgsLTEyMTE1MTE0OTgsOT
