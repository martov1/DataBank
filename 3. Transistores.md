...
4. Por **ley de ohm** en el resistor si $V_{be}$ es fija entonces debajo del transistor  $I_e$ **tambien es fija**
...
[fuente](https://www.youtube.com/watch?v=oF_VDtF7ptg)
Haciendo el calculo vemos que **no hay ningun momento en el que haga falta usar** $\beta$ para calcular $V_{ce}$ ni $I_c$
...
Para eso usamos un **voltage divider bias** que asegure una corriente $I_e$ especifica. Mientras $I_b$ sea pequeña compaarada con $I_e$ (osea, mientras $\beta$ sea grande, que ca
![](https://i.imgur.com/ZaZg8Yt.png =150x)
### Led driver - WIP
[fuente](https://www.youtube.com/watch?v=owtEicKOGnI)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4NzgxNDI0NDAsMTc2NTIyOTM1NSwtMT
Y4NzkzMzQ2OSwxNTg2NjQ4NTQzLDEwMDgwMjIyNDksLTE5ODE2
MTY1NDksMTk4MjU0MzQzMSwxNjI2MDMzNzY1LC0yOTEzMTg3NT
ksLTI5MjA0MzA5NCwxNDA4NzI3MjI3LC0yMTI0MzQ5NjczLC03
MjUwODY1ODUsLTE1ODEwNjE3MjgsLTE4NzI1MTE2NDksLTQzND
c3MDA1MCwtMTgxMTQ2MDY3OCwyNzQzMjk0NzcsMjI1NjYxMDA3
LDgxMDUyOTA5NF19
-->