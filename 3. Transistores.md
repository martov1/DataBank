...
2. Cuando hay señal de entrada, $C1$ se descarga hacia $Q1$, chupando la corriente que normalmente va a la base de $Q2$ hasta cargarse
	* ![](https://i.imgur.com/aFKjCwU.png =500x)
3. . Cuando $C1$ se carga con polaridad inversa, vuelve a fluir corriente a la base de $Q2$, satura finalizando el pulso
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTM4OTIzNjA0LDE3OTI5NjU0MDAsLTEwMj
