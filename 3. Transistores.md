...
Ademas seguir con _the art of electronics_


_**nota:** este sistema usa el mismo fundamento que el amplificador de tension_

>Podemos usar nuestro emitter-follower para **reducir la impedancia de una señal AC**, para hacerlo tenemos que tener en cuenta que:
...
Para eso
3.  creamos una tension de referencia en la base emitter-follower con un valor de $\frac{V_{cc}}{2}$  para permitir _maximo swing de la onda_, simplemente con un **voltage divider** usando $R_1$ y $R_2$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NDAwMTMwODgsLTEyOTA5MDgxNTcsMT
...
NDcwNTQ5MiwtMjY0MTEzOTUzLC0xNTY4MzAwMTU2LDI2NzkzOD
A2NywtMTM4NDEyNDY1MCwyNjkyOTY5NjAsOTc0MTU1MjY3LDIw
NTA3NzQ1M119
-->