...
1. La **quesient current** $I_e$ que queremos tener cuando no exista ninguna señal. la elegimos segun la corriente "maxima" que se banque el transistor (viendo el datasheet)
2. Eso nos va a determinar $R_e$ por ley de ohm
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY2Mjk5NzQwNSwtMTQxNzE5NDYwOCwtMj
