...
4. Definimos $V_{cc}$ **minimo**  necesario para el compliance deseado, sabiendo que se debe cumlir que $V_{ce}>0.3$.
	...
	* listo, tengo todos los datos para despejar $V_{cc}$
...
* entonces hago que $I_b$ sea insignificante comparado con la tension que pasa por el voltage divide
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MjA1OTExOTgsLTEyMTE1MTE0OTgsOT
