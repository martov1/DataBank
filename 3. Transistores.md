...
### Emitter-follower  coupled alifier - WIP

#### Intro

[fuente 1](https://www.youtube.com/watch?v=Xjf1bMW-NZo&list=PLvs4GyVYMn63eWvF5v8U5NvYVbzPXEf91&index=)
[ee(https://www.youtube.com/watch?v=n_bBF67mqk8&list=PLHOCl8mhMVsI6WaxcvorWOJ4V9XjNa9ot&index=3)
...
podemos usar n emiter-e ooe o*reducir la impedanca de una señal AC**, o dicho de otra manera "amplificar lie
...
Para eso:
1  Creo un voltaje de referencia  alimenta la base del isor usado  **voltage divider** usando $R_1$ y $R_2$
2 Acoplo la señal AC aa teo d refrencia usando un **coupling capacitor**
3. Ahora que o señal montada sobre una señal DC positiva, ya no tengo problemas para amplifica on lstor. asi que la uso para **alimentar el emitter-follower**
...
[fuente 1 - AC/DC equivalent circuit](https://www.youtueoatcS3xKw&list=PLZvLSclgk4yIxWlpkNfiJKG4eOxZUyvfi&index=18)
[fuente 2 - in $_{t}$tps://.outubecom/at-&list=PLv4ye1&index=9)
[fuente 3 - $Z_{in}$ y $Z_{out}$wwyoutube.com/watch?v=Xjf1bMW-NZo&list=PLvs4GyVYMn63eWvF5v8U5NvYVbzPXEf91&index=19)

:warning: - :warning:	- 	:warning:  - :warning:
** siguiente modelo **ignora las resistencias internas del transistor** por lo que no es muy exacto (puede ser hasta [50%](https://electronics.stackexchange.com/questions/547108/trouble-understanding-output-impedance-of-common-collector/547262#547262) inexacto!)
...
**La impedancia de salida** es simplemente hevenin que ve la carga en **AC**.
**TIENE SENTIDO!:** al final del dia, mi ampli no es mas que **una etencia de thevenin para mi pequeña señal AC!** osea que lo que va a limitar la corriente que va a proveer la señal de u va a er la sea de en ($_{}$)
$Z_{in}$ v a ser la resistencia que ve la señal de entrada, en este caso vemos que la corriente **AC** de la señal puede ir 
...
**Entonces:** 
$$\boxed{Z_{in}= R1 || R2 || \beta R_eoe ao    $$

 edcia e ut 

uente 1 - AC/DC equivalent circuitloene      ](https://www.youtube.com/watch?v=6ktpjTS3xKw&list=PLZvLSclgk4yIxWlpkNfiJKG4eOxZUyvfi&index=18)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzc5ODkyOTMwLC0xODMxMzIxMTE4LDMyOT
g3NDU2OCwtMzY1NjA1MTI0LDgyMzE4NDIxMyw1MjUxNTQ0ODks
LTE2OTY3ODIzNDUsNDI5OTM3ODI0LDE3NzQyMjY1NzYsMTA5NT
