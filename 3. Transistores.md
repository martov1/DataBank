...
1. Generar una tension de referencia con un diodo zener $V_{in}$
...
### Emitter-follower AC coupled amplifier - WIP
...
_**nota:** este sistema usa el mismo fundamento que el amplificador de tension_


Uodemos usar nuestro emitter-follower para **reducir la impedancia de una señal AC**
...
* sea positiva cuando llegue al transistor
...
Para eso:
1.  Creamos una tension de referencia que alimente la base del emitter-follower con un  **voltage divider** usando $R_1$ y $R_2$
2. **Acoplamos** nuestra señal AC a esa tension de referencia con un **coupling capacitor**. 
3. El emitter follower copiara esa tension, pero ahora puede proveer la corriente que pueda darte mas corriente!
	3. Del emisor sale una corriente correspondiente a $I_b*\beta$, donde $I_b$ sale casi totalmente del divisor de tension y no de la señal original.
...
[ver1](https://www.youtube.com/watch?v=6ktpjTS3xKw&list=PLZvLSclgk4yIxWlpkNfiJKG4eOxZUyvfi&index=18)
...
* (es $\beta +1$ por que estrictamente, 
...
* Quiesent current es la suficiente para no quemar el transistor!
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkzMzE0MTQzNywtMjAyNjAwMTQ0MSw3Nz
kwNTM0ODgsMTQ5OTE4ODY5MiwxNDUyNjE3MDE0LC0xNjQ3MTUw
OTQzLC02OTg5ODE2ODUsMTA4ODU5NzE2NywtMTc3MDg2MzcyNy
wxNzg3Nzg0NzQzLDEyOTI3OTIzNTksMjA4MjQ0ODg2Myw5MTU2
ODg1OSwtMTEwMjIxMTcwMywtNDEyMDY3MTAxLC0xMzkyNDA1OD
I1LDE1NTE5MTgxNjcsMTQwNzUwNTQ5OSwtNzc2MDc1NTk1LDE2
MTk0NDM1MzVdfQ==
-->