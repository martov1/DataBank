...
Queremos que nuestro circuito pueda generar una corriente $I_c$al transistor de una corriente $I_b$ fija que no dependa del $\beta$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc3NDYxNzc1MSwtMTcxMTIzNTA1LC0xMD
