...
### Generador de pulso cuadrado

Este circuito detecta cuando existe una tension en una entrada y genera un **pulso cuadrado de una duracion fija determinada**, independientemente de la duracion y forma de la tension de entrada.

[ejemplo](https://tinyurl.com/yy9hppf8)
![](https://i.imgur.com/GyUYVNb.png)
**Funcionamiento:**
...
2. Cuando hay señal de entrada, $C1$ se descarga invirtiendo polaridad, chupando la corriente que normalmente va a la base de $Q2$ hasta cargarse
	* ![](https://i.imgur.com/aFKjCwU.png)
3. . Cuando $C1$ se carga con polaridad inversa, vuelve a fluir corriente a la base de $Q2$, finalizando el pulso
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTc1NTE0MjAzLDE3OTI5NjU0MDAsLTEwMj
M0NzI2OTgsMTQ5OTMzNjczMywtMTUwNjYwNDE2MCwtODI4Mjk5
NzYzLC0yMTQ3Mzc3NDQyLDkyNTcyMDc2NiwtMTMxMjE4ODEzMC
wtMjA0NzEwMDc3MSwtMTQwNDA0MzA5OCw0MzQ0ODIwNzQsMTQx
MjQwNzIyOSwtODYxODUyNDAxLDExMTQxNDMwNDcsMjEwNzY5Mz
Q4OCwxMzUxNjQwNjM0LC0xNzAzNDg1MDI1LC0xOTg1ODkyNjU0
LDE2OTQ3MzYzMF19
-->