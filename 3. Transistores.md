...
2 Acoplo la señal AC aa teo d refrerncia usando un **coupling capacitor**
3. Ahora que oseñal montada sobre una señal DC positiva, ya no tengo problemas para amplifica on lstor. asi que la uso para **alimentar  emier**
...
* La **quesient current** $I_e$ que queremos tener cuando no exista ninguna señal. la elegimos segun la corriente "maxima" que se banque el transistor (viendo el datasheet)
	* Eso nos va a determinar $R_e$ por ley de ohm
* La **tension de bias de la base**, generalmente elegimos $\frac{V_cc}{2}$, o si queremos ser mas especificos y tener en cuenta la caida de tension del diodo que esta en la base del transistor, $\frac{V_cc-0.7}{2}$
	* En base a eso elegimos $R_1$ y $R_2$ 
...
[fuent 2](https://tinyurl.com/y7c6umte)
...
### Media onda
[fuente](ht)
uente   alculo eneralestps://www.youtube.com/watch?v=Aa8Yb4VIw8w&t=1435s)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTk5ODY4OTA4OCwtMTQxNzE5NDYwOCwtMj
AzMzgyMTY3MywtNjY3NzgwNDg0LC0xNjE1ODQxODYzLDE4NTUx
NDI5MDAsMTM0ODA3MDkzNywxNzMzNjQ4NTU3LC0xNTc0NDA3OT
Q2LDMyOTg3NDU2OCwtMzY1NjA1MTI0LDgyMzE4NDIxMyw1MjUx
NTQ0ODksLTE2OTY3ODIzNDUsNDI5OTM3ODI0LDE3NzQyMjY1Nz
YsMTA5NTk5MDk2MywtNjI4NjQ0MTA3LDI5OTM3Njk2NywxMzk1
Mjk0MTQyXX0=
-->