...
* **Radial rake angle**
El angulo que forma el cortador con el eje de la herramienta, puede ser positivo (Hacia el material), neutro (perpendicular al material) o negativo (Hacia el lado contrario al material) como se muestra 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEwOTY0MjA4MSwxMDU0OTE2MjYxLDE3OT
