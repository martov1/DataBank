...
**CONCLUSION:**
A partir de  $V_{ds}=V_{g}-V_{th}$ la corriente queda trabada, y aumentar $V_{ds}$ solo aumenta una **depletion zone** que se va comiendo la diferencia entre $V_{g}-V_{th}$ y $V_{ds}$, y esa caida no aporta al movimiento de la coriente (similar a como la caida de $0.7V$ de un diodo no respeta la ley de ohm y no hace circular una corriente )
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ0NTUyNTQzNSwxMDMzMTYyMDQsLTExNj
M4NDQ4MjUsNzQ5NDE3Nzg1LDE1MzQzMDYzMDUsMjIxNDAwMzQ1
LC0yMDkwNzE5NTgxLDEyMzc0NjEzOTUsMTYwNjM3MjQzMiwtMz
A4OTk3NjgxLDEwMzUwNTI3MTksMzg3Nzg1NDIzLDc2MjM1MzI0
Niw0NDIzNTczNDAsLTE5NTQzNzA4NzksLTExNjYyOTYwNDcsLT
IxMzM0MTUsMjEzMjE5ODI3NSwtNzA3Mzk4NTYsLTMxNzgwNDY4
MF19
-->