...
**Vemos que** para un $V_{gs}$ determinado y fijo se respeta que  $\frac{V_{ds}}{I_d}=cte$ y ese es el comporamiento de la ley de ohm, y llamaremos a esa resistencia constante $R_{dsOn}$
**Entonces:**
$\frac{V_{ds}}{I_d}=R_{dsOn}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQyODIyODY5OSwtMTAxMjU1NzgyNiwtMj
