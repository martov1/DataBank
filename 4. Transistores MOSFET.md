...
### Deduccion de zonas de operacion
...
Esa cantidad de carga la podemos definir como la carga que se genera cuand el capacitor alcanza una tension llamada **threshold** o $V_{th}$

![](https://i.imgur.com/PZKtudT.png =400x)
Cuanto **mas cargado esta el capacitor, menor resistencia tiene el canal ya que es mas ancho y hay mas electrones para mover**
...
Si $V_{ds}$ sigue aumentando, como el capacitor formado no es simetrico, el canal se enzancha mas del lado del **gate y source** pero no tanto en el lado del **drain y source**.
Eventualmente para algun valor de $V_{ds}$este efecto se hace tan dramatico que se empieza a generar una forma de triangulo que **acogota el canal** y  la corriente **deja de crecer**.
![](https://i.imgur.com/Lo2ld8C.png)
Llamamos a esto la **zona de saturacion**

![](https://i.imgur.com/SwKlfJJ.png)

## Ecuaciones que lo gobiernan - WIP

[fuente](https://www.youtube.com/watch?v=QCIDcB034Eg&t=35s)

El mosfet esta gobernado por fenomenos ya conocidos por nosotros.

>**Recordamos:**
>1. **Expresion para la corriente**
$$(1) \quad \quad i=\frac{dQ}{dt}\approx\frac{\Delta Q}{\Delta t}$$
>
>2. **Definicion de la capacitancia** 
$$(2) \quad \quad C=\frac{Q}{V}$$
>
>3. **Calculo de la capacitancia** de un capacitor conformado por dos placas
$(3) \quad C=\text{permitividad del material} \frac{\text{area de placas}}{\text{distancia entre placas}}$
osea
$(3) \quad\quad C=\epsilon \frac{\text{A}}{\text{D}}=\frac{\text{ancho*alto}}{\text{D}}$
...
La capacitancia $C$ del MOSFET  nos determina la cantidad de electrones que quedan flotando en el **P-type**  $Q_{libres}$  y que permiten la conduccion. 
**Entonces:** la cantidad de electrones libres  $Q_{libres}$ flotando en el **P-type** que tenemos nos limitara la corriente maxima $I_d$ que podemos desplazar.

**Recordamos:** la definicion de corriente 
$$I_d=\frac{dQ}{dt}\approx \frac{\Delta Q}{\Delta t}$$

Entonces si sabemos cuanto tardan una carga equivalente a $Q_{libres}$ en circular, sabremos la corriente $I_d$ maxima
$$I_d\approx \frac{Q_{libres}}{t_{\text{que tardan en circular}}}$$

La cantidad de corriente que puede mover el MOSFET depende del "ancho del canal", que significa que depende de "la cantidad de electrones que estan de mas y se pueden mover libremente"
Vemos que  la carga $Q$ que contiene el capacitor del MOSFET sera la carga $Q$ que se movilizara para gene 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODE3NjY2MTksLTk4NDU4ODcwNiw3Nz
kxNjEsMzkyMTUzMjE4LDg4MzU4MTI1NiwtMTQyOTM1OTMxOSwt
Nzg0NTU3OTQyLDEzODkyMjc2NjksOTg2MjM2NDcsNzM4MjIzOT
UzLC05MTY1NDE2MjIsLTM5MzYyOTAyMywxOTkzMjg3NzY2LC0z
NzM5MzExMzksMTQyNjgzNDk1MCwxMDk4NDM4NjUzLC05NDY0ND
Q1MCwxMDgzOTU3MTY3LDQ4NjkwMDEwLDk0Njg5MjMwM119
-->