...
Como la tension no sera homogenea, **no podemos usar el promedio de la tension** $\frac{V_s+V_d}{2}$, sino que tenemos que hablar una funcion  $V_{channel}$ que varia con la posicion $X$ a lo largo del canal y representa la tennsion entre el punto $X$ y la tension en $V_{g}$
La equacion quedaria asi. 
$$(2) \quad V_{cap} = V_{gs}-V_{channel}(x)$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMxNzg2Mjg3NSw2NDI2OTU2NzksNzEyMz
M5MTE4LC0xMTk1NzI4OTE4LDE0NDU1MjU0MzUsMTAzMzE2MjA0
LC0xMTYzODQ0ODI1LDc0OTQxNzc4NSwxNTM0MzA2MzA1LDIyMT
QwMDM0NSwtMjA5MDcxOTU4MSwxMjM3NDYxMzk1LDE2MDYzNzI0
MzIsLTMwODk5NzY4MSwxMDM1MDUyNzE5LDM4Nzc4NTQyMyw3Nj
IzNTMyNDYsNDQyMzU3MzQwLC0xOTU0MzcwODc5LC0xMTY2Mjk2
MDQ3XX0=
-->