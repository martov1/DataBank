...
**Vemos acontinuacion** un ejemplo de cuando $V_{ds}>V_{gs}-V_{th}$, que implica por lo anterior que $V_{cap}<V_{th}$ en algun punto $X$, y en ese punto entonces la carga sera cero $Q=0$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NTQzNzA4NzksLTExNjYyOTYwNDcsLT
...
MiwxOTgxNjA2MDUxLC0yMTAyOTYyMTU5LC0xMjQ0NDQ0NjIwLD
g3NjM5MDc3Niw4NzY0NTM0NDYsLTgzMzA5MjE3NCwxNjc1ODAy
ODgwXX0=
-->