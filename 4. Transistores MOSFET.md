 ...
 **Asumimos** que el MOSFET esta en **saturacion** y decidimos **ignorar el channel length modulation**, es decir que usaremos la equacion $(2)$
...
Una vez despejado $\color{blue}I_d$ podemos despejar $\color{red}V_{gs}$ de $(2)$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgzNjc4MjkxMiwxMzc2MDQxNDk3LDEzMD
