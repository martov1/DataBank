...
2. Entonces  $V_{cs}(x)$ 
 ...
 $$\boxed{(5) \quad V_{d}\leq V_{cs}(x) \leq V_{s} \quad \forall x}$$
**Entonces:**
...
**ENTONCES:**
5.  Imaginemos que se da que  $V_{ds}>V_{g}-V_{th}$
6. Por la equacion $(4)$ existe un punto $X$ en donde $V_{channel}=V_{g}-V_{th}$, llamamos a ese valor $V_{dsSat}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzYxMDgzNTQ5LDY0MjY5NTY3OSw3MTIzMz
