...
Para atravesar el espacio $X$ que queda donde no hay electrones (por que $Q=$), se genera la caída de potencial entre $V_{channel}=V_{g}-V_{th}$ y la tension  $V_{ds}$.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ0MjA4MTU4NSwtMTE2Mzg0NDgyNSw3ND
