...
2. Entonces  $V_{cs}(x)$ comienza en $V_d$ al comienzo del canal y **baja a medida que avanzamos en** $X$ hasta llegar a $V_s$ al final del canal

 $$\boxed{(5) \quad V_{d}<V_{cs}(x)<V_{s} \quad \forall x}$$
**Entonces:**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyOTQwMjIxODgsNjQyNjk1Njc5LDcxMj
