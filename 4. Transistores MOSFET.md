...
>$$ \quad V_{c}=\frac{V_s+V_d}{2}$$
>
>$$(8) \quad V_{c}=\frac{V_s+V_d}{2}$$
>![](https://i.imgur.com/KfefCjZ.png)>


Reemplazando $(8)$ en $(7)$

$$ I_d\approx \frac{\epsilon WL\mu_QV_{ds}}{L^2D_{oxido}}(\frac{V_s+V_d}{2}-V_{th})$$

Con un poco de algebra se reacomoda

_divido la fraccion_
$$ I_d\approx \frac{\epsilon WL\mu_QV_{ds}}{L^2D_{oxido}}(\frac{V_s}{2}+\frac{V_d}{2}-V_{th})$$

_sumo 0_
$$ I_d\approx \frac{\epsilon WL\mu_QV_{ds}}{L^2D_{oxido}}(\frac{V_s}{2}+\frac{V_d}{2}+(\frac{V_s}{2}-\frac{V_s}{2})-V_{th})$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjI4Mjk3MDQsLTE0NDExMDg2OTIsLTE5ND
gyNTE4NzYsMzI4OTU4ODA5LDEzNzU5ODc2MDMsLTEzNTMzNzM3
NjgsLTk4NDU4ODcwNiw3NzkxNjEsMzkyMTUzMjE4LDg4MzU4MT
I1NiwtMTQyOTM1OTMxOSwtNzg0NTU3OTQyLDEzODkyMjc2Njks
OTg2MjM2NDcsNzM4MjIzOTUzLC05MTY1NDE2MjIsLTM5MzYyOT
AyMywxOTkzMjg3NzY2LC0zNzM5MzExMzksMTQyNjgzNDk1MF19
