...
**CONCLUSION:**
1. Recordamos la equacion $(4)$ $V_{d}<V_{channel}(x)<V_{s} \quad \forall x$ 
2. Imaginemos que se da que  $V_{ds}>V_{g}-V_{th}$
3. Por la  concusion 1 existe un punto $X$ en donde $Q=0$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MjAxNTc1OTIsNzQ5NDE3Nzg1LDE1Mz
