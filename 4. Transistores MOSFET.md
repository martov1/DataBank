...
* Todas las posibles combinaciones de $I_d$ y $V_{ds}$ para este circuito
* **Para cada valor de** $V_{gs}$ **determinar que valores de**  $V{ds}$ y $I_d$ tendre
* En concecuencia, se que valor de $R_{dsOn}$ tendre, ya que puedo despejar
	*  $\frac{V_{ds}}{R_{dsOn}}=I_d$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTQwMzI5MTksMTk0NjU3MjczOSwtMT
