...
* **Zona lineal**
	* Ocurre cuando  $V_{ds}<V_{gs}-V_{th}$
	* $I_d (V_{gs},V_{ds}) = k((V_{gs}-V_t)V_{ds}-\frac{1}{2}V_{ds}^2)$
	* Es **una parabola** (si $V_{gs}$ es cte)
* **Zona Saturacion**
	* Ocurre cuando  $V_{ds}>V_{gs}-V_{th}$
	* $I_d (V_{gs}) = k\frac{1}{2}(V_{g}-V_{th})^2$
	* Es **una parabola**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODE0MTY5ODgsLTUxNTk4NjU1NCwxODk5Nj
k2MTU0LC0xMzI4NjUwOTM5LC0zNzQyODQyMTUsNDE0NTg3MzU3
LC0xODE0NDI5MTEzLC0xMzk1MTM3NjMzLDE4MDcxMzE4MTIsLT
U3NzYwNjM1NSw2MjgwNjQ5ODYsLTE0NjE2MTE1MywxMDg2ODgw
NDY3LDQ0MDY2NTgzMiw2NDI2OTU2NzksNzEyMzM5MTE4LC0xMT
k1NzI4OTE4LDE0NDU1MjU0MzUsMTAzMzE2MjA0LC0xMTYzODQ0
ODI1XX0=
-->