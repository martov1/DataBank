...
$$(7) \quad I_d\approx \frac{\epsilon WL\mu_Q\frac{V_{ds}}{L}}{LD_{oxido}}(V_{cap}-V_{th})$$


$$(7) \quad I_d\approx \frac{\epsilon WL\mu_Q}{L^2D_{oxido}}V_{ds}(V_{cap}-V_{th})$$

Para simplificar aun mas, tomamos todos los parametroos que son constantes del dispositivo, tales como la distancias, la conductacia, el ancho y largo del capacitor etc y los renombramos como $k$
...
$$ I_d\approx \frac{\epsilon WL\mu_QV_{ds}}{L^2D_{oxido}}(V_g-\frac{V_s+V_d}{2}-V_{th})$$

Con un poco de algebra se reacomoda

_divido la fraccion_
$$ I_d\approx \frac{\epsilon WL\mu_QV_{ds}}{L^2D_{oxido}}(V_g-\frac{V_s}{2}+\frac{V_d}{2}-V_{th})$$

_sumo 0 en forma de_ $\frac{V_s}{2}-\frac{V_s}{2}$
$$ I_d\approx \frac{\epsilon WL\mu_QV_{ds}}{L^2D_{oxido}}(V_g-\frac{V_s}{2}+\frac{V_d}{2}+(\frac{V_s}{2}-\frac{V_s}{2})-V_{th})$$

Reordenando
$$ I_d\approx \frac{\epsilon WL\mu_QV_{ds}}{L^2D_{oxido}}(V_g-(\frac{V_s}{2}+\frac{V_s}{2})+(\frac{V_d}{2}-\frac{V_s}{2})-V_{th})$$

queda
$$ I_d\approx \frac{\epsilon WL\mu_QV_{ds}}{L^2D_{oxido}}(V_g-V_s+\frac{1}{2}(V_d-V_s)-V_{th})$$
Entonces
$$ I_d\approx \frac{\epsilon WL\mu_QV_{ds}}{L^2D_{oxido}}(V_{gs}+\frac{1}{2}V_{ds}-V_{th})$$

Bajo el $V_{ds}$ de la fraccion e identifico el calculo de todos los  parametros fijos para el dispositivo como $k$
$$I_d\approx kV_{ds}(V_{gs}+\frac{1}{2}V_{ds}-V_{th})$$

Hago disributiva
$$I_d\approx kV_{gs}V_{ds}+\frac{1}{2}V_{ds}V_{ds}-V_{th}V_{ds}$$

**Quedando** entonces la equacion que relaciona $I_d$, $V_{ds}$ y $V_{gs}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODUyNTUwODc5LDE2NzU4MDI4ODAsLTE0ND
ExMDg2OTIsLTE5NDgyNTE4NzYsMzI4OTU4ODA5LDEzNzU5ODc2
MDMsLTEzNTMzNzM3NjgsLTk4NDU4ODcwNiw3NzkxNjEsMzkyMT
UzMjE4LDg4MzU4MTI1NiwtMTQyOTM1OTMxOSwtNzg0NTU3OTQy
LDEzODkyMjc2NjksOTg2MjM2NDcsNzM4MjIzOTUzLC05MTY1ND
E2MjIsLTM5MzYyOTAyMywxOTkzMjg3NzY2LC0zNzM5MzExMzld
fQ==
-->