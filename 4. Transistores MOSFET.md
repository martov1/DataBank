...
* $\color{orange}R_{dsOn}=0$, _osea el mosfet conduce totalmente_
	*  La **corriente** $I_d$ de este circuito sera
	 **Maxima** y sera limtada solo por **el circuito ALREDEDOR DEL MOSFET** 
...
* $R_{dsOn}$ tiene que estar entre $\infty$ y $0$
* En el medio, La relacion entre $V_{ds}$ y $I_d$ tiene que ser **lineal** (ley de ohm)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzM4NTYxMDMsNTUyNDUzMjU4LDE5NDY1Nz
