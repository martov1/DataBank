...
**Vemos acontinuacion** un ejemplo  de cuando $V_{ds}>V_{gs}-V_{th}$, que implica por lo anterior que $V_{cap}<V_{th}$ en algun punto $X$, y en ese punto entonces por la equacion $(1)$ la carga sera cero $Q=0$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NzQyMjY0ODksNzYyMzUzMjQ2LDQ0Mj
...
LDQ1NTcwMDM5OSwtMTAyNTMxMDQxLC0xMDAxNTA1NjMyLDE5OD
E2MDYwNTEsLTIxMDI5NjIxNTksLTEyNDQ0NDQ2MjAsODc2Mzkw
Nzc2XX0=
-->