...
Esta sera la **peor** $R_{dsOn}$, es decir **la mas alta**, ya que responde a la curva menos pronunciada por que elegimos usar 
...
* La resistencia es aproximadamente $R_{dsOn}=0.00833$ o menos si elegimos un $V_{gs}$ mas alto
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1MTQxMjE0MSwxMDA2MDAzNTk4LDgwOT
