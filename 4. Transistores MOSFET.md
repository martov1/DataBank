...
**Entonces** en el punto $x$ donde $V_{cs}(x)=V_{g}-V_{th}$ la equacion $(3)$ se transforma en la  $(6)$ y or consiguiente desde ese punto $x$ en adelante el capacitor no tiene carga por que $Q=0$ 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTk5NTE1ODU5LC0xNDYxNjExNTMsMTA4Nj
