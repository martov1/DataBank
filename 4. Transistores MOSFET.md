...
$\color{magenta}\text{Esta linea representa todas las combinaciones  posibles de }I_d \text{ y } V_{ds}$$
 si el MOSFET **fuera un resistencia variable**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkwODc5ODg3NiwxOTQ2NTcyNzM5LC0xMT
