...
Por eso decimos que la capacitancia de miller **no es lineal** sino que cambia con la tension $V_{ds}$, esto es por que el capacitor esta expuesto a la tension $V_{d}$ y a la tension $V_{g}$. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkwNzkzMjAzOSwyNTIwODU4MzcsLTg5NT
