...
**EL PINCH-OFF:**
Si planteamos que  $V_{ds}>V_{gs}-V_{th}$, implica  que en algun punto $X$ se dara que $V_{ds}=V_{gs}-V_{th}$, eso implica que 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NzMzOTUyMSwzODc3ODU0MjMsNzYyMz
