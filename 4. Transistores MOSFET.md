...
### Introduccion - WIP
[fuente](https://www.youtube.com/watch?v=pP7WWM63Upc&t=541s)

**ATENCION!!!!!!!! ESTA FUNDAMENTACION ES INCORRECTA, SI YO QUISIERA ESTAR EN LA ZONA DE SATURACION POR LA RELACION CUADRATICA ENTONCES NO HARIA EL MODELO DE PEQUEÑA SEÑAL COMO UNA FUNCION LINEAL!!!!! EL MOTIVO ES PARA MINIMIZAR LA DISTORSION. EL TRADUCTOR DE INGENIERIA ESTA EQUIVOCADO**
[VER ACA](https://www.quora.com/Why-does-MOSFET-operate-in-saturation-to-act-as-an-amplifier)


**Recordamos** la **funcion de transferencia** del MOSFET, es decir como varia la **salida** $I_d$ con cambios de la **entrada** $V_{gs}$.
![](https://i.imgur.com/NYiagzk.png =400x)
**Recordamos:** 
* Este grafico representa la variacion en la salida $I_d$ con respecto a la entrada $V_{gs}$
* Este grafico asume que la segunda salida $V_{ds}$ es constante
* La equacion en saturacion con cambios de $V_{gs}$ 
	* Ocurre cuando  $V_{ds}>V_{gs}-V_{th}$
	*  es independiente de $V_{ds}$
	* Es una **parabola** cuando $V_{gs}$ cambia
		* $I_d (V_{gs}) = k\frac{1}{2}(V_{g}-V_{th})^2$

**Entonces:** 
1. Si logramos **mantenernos en la region de saturacion**  ($V_{ds}>V_{gs}-V_{th}$)
2. Podemos montar una señal sobre la tension $V_{gs}$ 
3. Obtendremos como resultado una salida de corriente $I_d$ con una relacion **cuadratica de amplificacion** con respecto a la entrada $V_{gs}$

**OSEA:** que  **un pequeño cambio** $\Delta V_{gs}$ generara **un gran cambio** $\Delta I_d$



![](https://i.imgur.com/4F0Bc8E.png)

Si nos aseguramos de mantenernos en la region de saturacion entonces 
* El valor exacto de $V_{ds}$ no nos importa en absoluto, por que en la region de saturacion $I_d$ es independiente de $V_{ds}$
* Mientras estemos en la region de saturacion tendremos ganancia cuadratica
* No salirme de la region de saturacion es facil, por que tengo que mantenerme en $V_{ds}>V_{gs}-V_{th}$, y generalmente mi señal montada sobre $V_{gs}$ va a ser chiquita.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY5NzIwNzQ4MCwtNzM5MDYyODE0LC0xNT
c5NTQ3MzQyLDE4MTQ3MjMzLC0xMTE1ODA4OTc3LDUxMzU4NTIz
OCwxMzQyMjE4NTE1LC05ODkzNjM5MTUsLTgzMzIwNjIyNSw0Mz
AxMDA2MDYsLTc0OTk2NDg2OCwtMjk3NzIzMzQ3LC01MTU5ODY1
NTQsMTg5OTY5NjE1NCwtMTMyODY1MDkzOSwtMzc0Mjg0MjE1LD
QxNDU4NzM1NywtMTgxNDQyOTExMywtMTM5NTEzNzYzMywxODA3
MTMxODEyXX0=
-->