...
1. **El channel**, generado por $V_{gs}-V_{th}$
2. **La depletion region** generada por el diodo ente drain y source y que esta polarizado inversamente por $V_{ds}$ 
	* _recordamos que un depletion region es una region sin electrones y por ende no conductora_
...
Las regiones tienen fuerzas similares cuando
$$V_{ds}>V_{gs}-V_{th}$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc1ODIxODIwMiwxOTgxNjA2MDUxLC0yMT
