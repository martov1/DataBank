...
**Notamos que:** 
1. La tension $V_{ds}$ en el  canal cae desde $V_{d}$ hasta $V_{s}$ a lo largo de la distancia $X$ del canal
...
A continuacion vemos que si $V_{ds}>V_{gs}-V_{th}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODI1ODA2ODExLDIxMzIxOTgyNzUsLTcwNz
