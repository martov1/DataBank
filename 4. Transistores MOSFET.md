...
A partir de  $V_{ds}=V_{g}-V_{th}$ la corriente $I_d$ queda trabada en su ultimo valor.
...
Recordando la formula para $I_{d}$ y evaluandola cuando $V_{ds}=V_{g}-V_{th}$ obtenemos el valor al que queda clavada la corriente, aun cuando $V_{ds}$ supere ese valor.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTc2NzM1NCwtMTE5NTcyODkxOCwxND
