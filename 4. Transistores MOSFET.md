...
Si graficamos la salida 1 $V_{ds}$ y la salida 2 $I_d$, cuando $V_{gs}$ se mantiene **constante** usando las tres regiones en los puntos que corresponde, tendremos la caracteristica de salida.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMDAxNjkxNTYsLTI5NzcyMzM0NywtNT
...
MTYxMTUzLDEwODY4ODA0NjcsNDQwNjY1ODMyLDY0MjY5NTY3OS
w3MTIzMzkxMTgsLTExOTU3Mjg5MTgsMTQ0NTUyNTQzNSwxMDMz
MTYyMDRdfQ==
-->