...
**EL PINCH-OFF:**
Cuando $V_{ds}>V_{gs}-V_{th}$, implica  por 1. que $V_{cap}<V_{th}$ en algun punto $X$, y en ese punto entonces por la equacion $(1)$ la carga sera cero $Q=0$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTIyODMzMzg0LDc2MjM1MzI0Niw0NDIzNT
