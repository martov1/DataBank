...
Para dibujarla usaremos dos puntos:

**1)cuando el transistor conduce** 
tengo que  $V_{ds}\approx0$ entonces

$I_{dmax} \approx 0+\frac{V_{fuente}}{R}$
Es como si el transistor **no estuviera**
![](https://i.imgur.com/0zJZCR0.png =400x)[simulacion](https://tinyurl.com/y7anrlrj)

**2)Cuando la corriente minima**
osea cuando el transistor esta en CUTOFF  y como concecuencia$I_d=0$ que es cuando $V_{ds}=V_{fuente}$
![](https://i.imgur.com/3rv43sr.png =400x)
[simulacion](https://tinyurl.com/yb8u3dar)


Dibujando los dos puntos obtengo una **recta**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTQ4OTMxODU3LC02NDYyNzc3LDI5Njk3Nz
kwNSwtMzY2MjE2Mjg1LDExNDM4OTY2MDIsMTA5ODY2NzI4OCw2
MTYyMDAwMDAsLTE3MzQ1NTQxNDcsLTMxMzUyODk4LDc4NTc1MD
UyLDQ0ODIwOTc0MCwtMTcwNjY5NDQxNSwtMTcwNjY5NDQxNSw5
MTk4MzcwNDIsMjE0MjIwNTkzNiw1NTI0NTMyNTgsMTk0NjU3Mj
czOSwtMTE0MDExODcwNywtNTE0MDI2MjY0LC0yMjgzODgxNjhd
fQ==
-->