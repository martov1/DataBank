...
osea
$$(8) \quad\quad C=\epsilon \frac{A_{rea}}{D_{istancia}}=\epsilon\frac{W_{idth}L_{ength}}{D_{istance}}$$

Reemplazando $(8)$ en $(7)$

$$(7) \quad I_d\approx \frac{\epsilon \frac{\text{A}}{\text{D}}(V_{gs}-V_{th})\mu_QE}{L}$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODQ4MTcwNjEzLC0xMzUzMzczNzY4LC05OD
