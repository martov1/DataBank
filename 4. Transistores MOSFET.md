...
**Entonces:**
Si $V_{fuente}$ y $R$ fueran **consantes** (que es lo normal) entonces  $I_d$ **depende unicamente de** $V_{ds}$ y lo hace **de forma lineal**

**Osea que es una recta que va:**

**1)Desde la corriente maxima, cuando el transistor esta en zona ohmica** 
Osea cuando la caida de tension en el transistor es minima 
$V_{ds}\approx0$

$$(3) \quad I_{dmax}= 0+\frac{V_{fuente}}{R}$$
![](https://i.imgur.com/0zJZCR0.png =400x)[simulacion](https://tinyurl.com/y7anrlrj)

**2)Hasta corriente minima, cuando el transistor esta en CUTOFF** 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMzQ1MTY0OCwtNjQ2Mjc3NywyOTY5Nz
c5MDUsLTM2NjIxNjI4NSwxMTQzODk2NjAyLDEwOTg2NjcyODgs
NjE2MjAwMDAwLC0xNzM0NTU0MTQ3LC0zMTM1Mjg5OCw3ODU3NT
A1Miw0NDgyMDk3NDAsLTE3MDY2OTQ0MTUsLTE3MDY2OTQ0MTUs
OTE5ODM3MDQyLDIxNDIyMDU5MzYsNTUyNDUzMjU4LDE5NDY1Nz
I3MzksLTExNDAxMTg3MDcsLTUxNDAyNjI2NCwtMjI4Mzg4MTY4
XX0=
-->