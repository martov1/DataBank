...
**Entonces** en el punto $x$ donde 
$$V_{cs}(x)=V_{dsSat}=V_{g}-V_{th}$$
 La equacion $(3)$ se transforma en la  $(6)$ y por consiguiente desde ese punto $x$ en adelante el capacitor no tiene carga por que $Q=0$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4Mjg1MzIwNjUsLTE0NjE2MTE1MywxMD
