...
* **Desde** la condicion cuando $\colorR_{dsOn}=0$, osea cuando la corriente solo esta limitada por el resto del circuito alrededor del mosfet.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTQyNzMxMDIwLDE5NDY1NzI3MzksLTExND
