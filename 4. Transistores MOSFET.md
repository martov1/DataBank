...
2. Elegir un bias point (conbinacion de $V_{gs}$ y $I_d$) donde tengas una combinaacion que te sirva de bias current (para no desperdiciar corriente)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTA5MzYyMDAsNzMzMTM1MTEsLTkzMz
