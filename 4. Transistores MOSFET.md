...
3. Entonces la cantidad de carga $Q$ va **subiendo** a medida que avanzamos en $X$ y cae $V_{channel}$
	* $V_{cap} = V_{g}-V_{channel}(x)$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTcxOTc0MjkzMyw3NDk0MTc3ODUsMTUzND
