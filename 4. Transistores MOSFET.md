...
**Para hacerlo** elegimos un MOSFET que tenga un $R_{dsOn}$ **bajito** segun el datasheet., generalmente $R_{dsOn}$ puede ser un valor mas o menos fijo ya que mirando el grafico vemos que todas las pendientes se parecen mucho.
...
![](https://i.imgur.com/DfpD4jU.png =400x)[EJEMPLO](https://tinyurl.com/yby5oas5)


Veamos el grafico del datasheet trazando el **load line** para sacar algunas conclusiones
![](https://i.imgur.com/ML6nzY2.png)
**vemos que:** 
	* cualquier $4V<V_{gs}<10V$ sera suficiente
	* $V_{gs}\approx 3V$ probablemente no nos alcance.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMyODM4MTg3NywxMDA2MDAzNTk4LDgwOT
YxNzgxOSwtMjAyNzE2NjgwMCwtMTI4MzA3NjQ1LDE4NTM2Njky
MDgsNjE3ODI3MDA4LDY1NjU5OTMxOSwtNjQ2Mjc3NywyOTY5Nz
c5MDUsLTM2NjIxNjI4NSwxMTQzODk2NjAyLDEwOTg2NjcyODgs
NjE2MjAwMDAwLC0xNzM0NTU0MTQ3LC0zMTM1Mjg5OCw3ODU3NT
A1Miw0NDgyMDk3NDAsLTE3MDY2OTQ0MTUsLTE3MDY2OTQ0MTVd
fQ==
-->