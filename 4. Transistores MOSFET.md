...
* $R_{dsOn}=\infty$, _osea como si el mosfet no conduce_
	*  La **corriente** $I_d=0$ 
	* La tension $V_{ds}$ sera $V_{cc}$

Sabemos que $R_{dsOn}$ tiene que estar entre $\infty$ y $0$, y que la relacion entre $V_{ds}$ y $I_d$ tiene que ser lineal al cambiar $R_{ds}$ (
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODI0ODM2NDIsLTIyODM4ODE2OCwtMTAxMj
U1NzgyNiwtMjcxODY1NDY3LC0xNjQ5NDk4MDg3LC01MzE5MTE2
NTksMTkxMDY4MTgyNSwyMDU1MDkxNTUsLTE1NzYyOTExMzAsMT
