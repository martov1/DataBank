...
* **Zona Cutoff:**
	...
	* $I_d=0$
* **Zona lineal**
	* Ocurre cuando  $V_{gs}-V_{th}<V_{ds}$
	* $I_d (V_{gs},V_{ds}) = k((V_{gs}-V_t)V_{ds}-\frac{1}{2}V_{ds}^2)$
* **Zona Saturacion**
	* Ocurre cuando  $V_{gs}-V_{th} \geq V_{ds}$
	* $I_d (V_{gs}) = k\frac{1}{2}(V_{g}-V_{th})^2$

Si graficamos la entrada $V_{gs}$ y la salida $I_d$, cuando $V_{ds}$ se mantiene **constante**,obtenemos la **relacion de transferencia**


### Caracteristica de salida - WIP
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzk0MDIxNjY1LDQxNDU4NzM1NywtMTgxND
QyOTExMywtMTM5NTEzNzYzMywxODA3MTMxODEyLC01Nzc2MDYz
NTUsNjI4MDY0OTg2LC0xNDYxNjExNTMsMTA4Njg4MDQ2Nyw0ND
A2NjU4MzIsNjQyNjk1Njc5LDcxMjMzOTExOCwtMTE5NTcyODkx
OCwxNDQ1NTI1NDM1LDEwMzMxNjIwNCwtMTE2Mzg0NDgyNSw3ND
