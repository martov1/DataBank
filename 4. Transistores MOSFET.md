...
**Notamos que:**
Esas equaciones _suponen_ que el capacitor es **homogeneo y simetrico**, pero notamos que ese **no es el caso.**, entonce ya no podemos considerar a $V_{cap}$ como la diferencia  entre $V_g$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyODQ4NDk5MSw4NzUxMjgzOTQsLTE0Nz
