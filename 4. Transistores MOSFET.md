...
**Entonces:**
3. La cantidad de carga $Q$ va **subiendo** a medida que avanzamos en $X$ y $V_{channel}$ se hace mas chiquito, por que vemos que 
$$Q_{libres}(x)=C([V_{g}-V_{th}]-V_{channel}(x))$$
4. Ademas si en algun momento $V_{cap}=V_{th}$ el canal se cierra y no hay carga en esa coordenada $X$ del capacitor.
	* **Por que** $Q=C(V_{th}-V_{th})=0$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4NDc3MTMxNCw3NDk0MTc3ODUsMTUzND
MwNjMwNSwyMjE0MDAzNDUsLTIwOTA3MTk1ODEsMTIzNzQ2MTM5
NSwxNjA2MzcyNDMyLC0zMDg5OTc2ODEsMTAzNTA1MjcxOSwzOD
c3ODU0MjMsNzYyMzUzMjQ2LDQ0MjM1NzM0MCwtMTk1NDM3MDg3
OSwtMTE2NjI5NjA0NywtMjEzMzQxNSwyMTMyMTk4Mjc1LC03MD
czOTg1NiwtMzE3ODA0NjgwLDg3NjI5OTg1Myw4NzUxMjgzOTRd
fQ==
-->