...
Esta linea **representa todas las combinaciones posibles de** $I_d$ y $V_{ds}$ que puede haber si el MOSFET **fuera un resistencia variable**
...
* Todas las posibles combinaciones de $I_d$ y $V_{ds}$ para este circuito, **que caen en la lineal violeta**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI3MzM4Mzk1MSwxOTQ2NTcyNzM5LC0xMT
