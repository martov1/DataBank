...
**Vemos que** para cada $V_{gs}$ fijo se respeta que  la relacion entre $V_{ds}$ y $I_d$ es una **recta** y **ese es el comporamiento de la ley de ohm**.

**Entonces:**
$$\boxed{\frac{V_{ds}}{I_d}=R_{dsOn} \quad \quad (\text{para un}  V_{gs} \text{ fijo }) }$$

Ahora bien, tengamos en cuenta el siguiente circuito
![](https://i.imgur.com/3rZX0Xs.png =400x)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTcxMjU0Mjg4MSwxOTQ2NTcyNzM5LC0xMT
...
MjY2NTE3NCwxNDQwNjc2NDY3LDcyMjU2MzYxOCwxMjczOTk0Nj
Q5LDEzNDczMjIxMDgsMjExMzM3NzQ0MCw3NjY1MDI3ODcsLTEw
MDg2MzMzNTRdfQ==
-->