...
* $R_{dsOn}=0$
	...
	* **Maxima** cuando el mosfet conduce totalmente ($R_{dsOn}\approx0$) y sera limtada solo por **el circuito ALREDEDOR del mosfet** 
		* Su valor sera $\frac{V_{cc}}{R_{load}}$
	* $0$ Cuando el mosfer **no conduce**  ($R_{dsOn}\approx \infty$)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI0Mjk5NTIxMCwtMjI4Mzg4MTY4LC0xMD
