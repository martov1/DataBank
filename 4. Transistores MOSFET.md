...
**Entonces:**
podemos dibujar una linea con 
* la condicion cuando $R_{dsOn}=0$, osea la maxima corriente que el circuito puede proveer si el transistor es un cable
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ1MzE3NTA4OCwtMjI4Mzg4MTY4LC0xMD
