...
* Conozco Todas las posibles combinaciones de $I_d$ y $V_{ds}$ para este circuito, $\color{magenta}\text{que caen en la lineal violeta}$
* **Para cada valor de** $V_{gs}$ **puedo determinar que valores de**  $V{ds}$ y $I_d$ tendre
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgxNzQ4ODQ3OSw1NTI0NTMyNTgsMTk0Nj
