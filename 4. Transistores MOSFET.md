...
A continuacion podemos ver la caracteristica de salida en la siguiente  simulacion

![](https://i.imgur.com/3EFzITZ.png)
[Simulacion](https://tinyurl.com/y9u7dqc5)
...
* El mosfet convierte la señal $\Delta V_{gs}$ en una señal de corriente $\Delta I_d$, luego esa señal la pasamos por un resistor $R$. para transformarlo en una señal $V_{amplificada}$ **la amplificacion depende en gran parte del valor del resistor**, por que por ley de ohm 
	* $\Delta I_d R=\Delta V_{amplificada}}{R}$
...
2. Elegir un bias point (conbinacion de $V_{gs}$ y $I_d$)  que te sirva
	...
	* un $V_{gs}$ que te genere una pendiente copada para mejorar la amplificacion 
![](https://i.imgur.com/SnLkqr9.png =300x)
3. En base a la variacion de $V_{gs}$ que va a tener tu señal, aproximar con el grafico la variacion de $I_b$![](https://i.imgur.com/TAuEXR6.png)
4. En base a la amplitud de corriente, elegir $R$ para  tener la amplitud de tension deseada por ley de ohm$\Delta I_d=\frac{\Delta V_{picoDeseado}}{R}$
5. **cuidado**, si elegir una $R$ muy grande entonces  la corriente maxima del circuito $I_{dmax}$ puede hacese tan pequeña que el MOSFET puede pasar a la zona lineal.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODc3OTI0MDEwLC0xMzkzODI2MDEwLDIwOT
c5NTcwMzAsLTEwODA3MjMyNTUsNzMzMTM1MTEsLTkzMzE2MjQ3
NSwxNjYxNDQxMDA4LC00ODg5NTQ2MTIsLTg2Mzg0MDk4NywtMT
Q1NjU2Mjc1MCwtOTg2NDkxNjgwLC0xMDQyMDkzMTYzLDE3Njcx
OTg0MzgsMTI2OTg1MjYxLC0zNTY5MzE0NDMsMTg0MDc5NDE0Ny
w3NTMzNjQ3NzYsLTEyNzQ2NzcyMzMsMTIxMDYyNTMzNSwtMTg3
MDQ1NTgxMV19
-->