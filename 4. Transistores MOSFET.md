...
Si dibujamos el load line veremos que es casi vertical! entonces siempre estaremos en saturacion ya que cualquiera sea el $V_{gs}$ que elijas siempre lo tocas en zona de saturacion
...
Dibujando el **load line** veremos que para valores chicos de $V_{gs}$ la corriente $I_d$ que puede dar el transistor es mucho mas baja que la corriente maxima que puede dar el circuito, estamos en **saturacion**
![](https://i.imgur.com/iT6FiwR.png =300x)
A medida que aumentamos $V_{gs}$ nuestro $I_d$ se va pareciendo mas y mas a la corriente maxima que puede dar el circuito.
![](https://i.imgur.com/cg6wgb0.png =300x)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg1MzY2OTIwOCw2MTc4MjcwMDgsNjU2NT
k5MzE5LC02NDYyNzc3LDI5Njk3NzkwNSwtMzY2MjE2Mjg1LDEx
NDM4OTY2MDIsMTA5ODY2NzI4OCw2MTYyMDAwMDAsLTE3MzQ1NT
QxNDcsLTMxMzUyODk4LDc4NTc1MDUyLDQ0ODIwOTc0MCwtMTcw
NjY5NDQxNSwtMTcwNjY5NDQxNSw5MTk4MzcwNDIsMjE0MjIwNT
kzNiw1NTI0NTMyNTgsMTk0NjU3MjczOSwtMTE0MDExODcwN119
