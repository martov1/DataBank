...
La capacitancia de miller **no es lineal** sino que cambia con la tension $V_{ds}$, esto es por que, si bien la cantidad de carga necesaria para cargarlo es lineal, la tension  
$C_{gd}=\frac{Q}{V}$

### Millers plateau - WIP
[fuente 1](https://www.infineon.com/dgdl/mosfet.pdf?fileId=5546d462533600a4015357444e913f4f)
[fuente 2](https://www.vishay.com/docs/73217/an608a.pdf)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NTM5MDMwNTksLTE2NjYxMTEwNTEsMj
