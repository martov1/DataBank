...
**Una vez que elegiste un bias point** y si tu **señal** $\Delta V_{gs}$ **es pequeña** entonces podes usar la derivada del grafico (transductancia) para aproximar $I_d$ 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5NzcyNzczMiwtMTAzOTA3MDMyMSwtNj
