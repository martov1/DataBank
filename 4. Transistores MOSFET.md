...
Entonces necesitamos considerar que $V_{cap}$ **cambia dependiendo de en que parte del capacitor estoy parado.**

El siguiente grafico muestra el valor de $V_{cap}$ segun la posicion $X$ en las placas  del capacitor.


**Notamos que:** En ningun momento sucede que  $V_{cap}\not{>}V_{gs}-V_{th}$, el motivo de esto se esclarecera en breve.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEzMjE5ODI3NSwtNzA3Mzk4NTYsLTMxNz
...
NjIwLDg3NjM5MDc3Niw4NzY0NTM0NDYsLTgzMzA5MjE3NCwxNj
c1ODAyODgwLC0xNDQxMTA4NjkyLC0xOTQ4MjUxODc2LDMyODk1
ODgwOV19
-->