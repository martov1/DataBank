...
Para estos casos extremos ya no podemos considerar a $V_{cap}$ como la tension en una placa $V_g$ menos el promedio de las tensiones en la otra placa. 

Debemos hablar de la tension $V_{channel}$ como funcion de la posicion $X$ 
...
Estoy buscando el lugar de $X$ donde la carrga del capacitor en ese lugar es  $Q=0$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU1MzkzNTQwOCwyMjE0MDAzNDUsLTIwOT
