...
**metodo 1:**
1. elegir una corriente de biasing $I_d$
2. Elegir el resistor $R$ para tener esa corriente de biasing
3. Colocar el bias point del transistor en la posicion optima eligiendo el offset para $V_{gs}$ 

**Metodo 2:**
1. mirar el grafico de
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTU4MDYzMDk1LDczMzEzNTExLC05MzMxNj
