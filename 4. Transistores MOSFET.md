...
**CRITICO:** Notamos que  cuando $V_{ds}>V_{gs}-V_{th}$ eso implica que $V_{ds}>V_{gs}-V_{th}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTI2ODQ4NDk4LDg3NjI5OTg1Myw4NzUxMj
...
NiwtODMzMDkyMTc0LDE2NzU4MDI4ODAsLTE0NDExMDg2OTIsLT
