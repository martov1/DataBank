...
![](https://i.imgur.com/ybIlcHL.png  =300x)
...
**sumamos:**
$$Q_{sg}+Q_{dg}=C_{sg} V_{g}+C_{dg} V_{dOFF}+C_{dg}V_{gON}$$

$$\boxed{Q_{t}=V_{dON(}C_{sg} V_{g}+C_{dg} V_{dOFF}+C_{dg}V_{gON}}$$
### Millers plateau - WIP
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzE4MTUxNjA1LDI1MjA4NTgzNywtODk1OD
