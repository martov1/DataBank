...
![](https://i.imgur.com/3rZX0Xs.png =400x)
**Sabemos que:**
* La **corriente** de este circuito sera
	*$I_d=$ **Maxima** cuando el mosfet conduce ($R_{dsOn}\approx0$) y sera limtada solo por **el circuito ALREDEDOR del mosfet** $\frac{V_{cc}}{R_{load}}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk5Mzg0MTcwMSwtMjI4Mzg4MTY4LC0xMD
