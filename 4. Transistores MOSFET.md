...
**Conclusion:**
A partir de  $V_{ds}=V_{g}-V_{th}$ la corriente queda trabada, y aumentar $V_{ds}$ solo aumenta una **depletion zone** que se va comiendo la
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg4ODM4MzIzNiwxMDMzMTYyMDQsLTExNj
