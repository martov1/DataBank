...
Ademas podemos aproximar el peor valor de $R_{dsOn}$ con la curva de menor pendiente $$
* $R_{dsOn}\approx 0.00625$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQxNDc4MTk1NCwxMDA2MDAzNTk4LDgwOT
