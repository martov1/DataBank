...
2. Por la equacion $(4)$ existe un punto $X$ en donde $V_{channel}=V_{g}-V_{th}$
3 Por la equacion $(3)$ en ese punto $Q=0$ 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExNjM4NDQ4MjUsNzQ5NDE3Nzg1LDE1Mz
