...
**Quedando** la funcion para la **region de saturacion del MOSFET**  cuando $V_{ds}>V_g-V_{th}$
...
* **Zona Saturacion**
	* Ocurre cuando  $V_{gs}-V_{th} \leq V_{ds}$
	* $I_d (V_{gs}) = k\frac{1}{2}(V_{g}-V_{th})^2$

Si graficamos la entrada $V_{gs}$ y la salida $I_d$, cuando $V_{ds}$ se mantiene **constante**.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NDY5OTM2OTgsLTM3NDI4NDIxNSw0MT
Q1ODczNTcsLTE4MTQ0MjkxMTMsLTEzOTUxMzc2MzMsMTgwNzEz
MTgxMiwtNTc3NjA2MzU1LDYyODA2NDk4NiwtMTQ2MTYxMTUzLD
EwODY4ODA0NjcsNDQwNjY1ODMyLDY0MjY5NTY3OSw3MTIzMzkx
MTgsLTExOTU3Mjg5MTgsMTQ0NTUyNTQzNSwxMDMzMTYyMDQsLT
ExNjM4NDQ4MjUsNzQ5NDE3Nzg1LDE1MzQzMDYzMDUsMjIxNDAw
MzQ1XX0=
-->