...
$$(1) \quad Q_{libres}=C(V_{chanel}-V_{th})$$
$$(2) \quad V_{chanel}\approx V_g-\frac{V_s+V_d}{2}$$
...
Debemos hablar de la tension $V_{ds}$ como funcion de la posicion $X$ 
$$(2) \quad V_{chanel}\approx V_g-V_{ds}(x)$$
>Esto implica que la carga del capacitor varia segun la posicion en $X$
$$(1) \quad Q_{libres}(x)=C(V_{chanel}(x)-V_{th})$$
...
3. Entonces la cantidad de carga $Q$ va bajando a medida que avanzamos en $X$ y cae $V_{channel}$
4. Ademas si en algun momento $V_{channel}<V_{th}$ el canal se cierra y no hay carga en esa coordenada $X$ del capacitor.
	* **Por que** $Q=C(V_{th}-V_{th})=0$
5. Entonces en esa seccion del canal teoricamente **no es posible la conduccion**

**EL PINCH-OFF:**
Si planteamos que  $V_{ds}>V_{gs}-V_{th}$, por el punto 1,  en algun punto $X$ se dara que $V_{ds}=V_{gs}-V_{th}$, eso implica que 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMwODk5NzY4MSwxMDM1MDUyNzE5LDM4Nz
c4NTQyMyw3NjIzNTMyNDYsNDQyMzU3MzQwLC0xOTU0MzcwODc5
LC0xMTY2Mjk2MDQ3LC0yMTMzNDE1LDIxMzIxOTgyNzUsLTcwNz
M5ODU2LC0zMTc4MDQ2ODAsODc2Mjk5ODUzLDg3NTEyODM5NCwt
MTQ3MTYyOTgzMyw1MjE5MzY3NTQsNDU1NzAwMzk5LC0xMDI1Mz
EwNDEsLTEwMDE1MDU2MzIsMTk4MTYwNjA1MSwtMjEwMjk2MjE1
OV19
-->