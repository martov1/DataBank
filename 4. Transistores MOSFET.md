...
$$(7) \quad I_d\approx \frac{\epsilon WL\mu_QV_{ds}}{L^2D_{oxido}}(V_{cap}-V_{th})$$
...
$$ kV_{ds}(V_{gs}+\frac{1}{2}V_{ds}-V_{th})$$

Hago disributiva
$$ kV_{gs}V_{ds}+\frac{1}{2}V_{ds}V_{ds}-V_{th}V_{ds}$$

$$ kV_{gs}V_{ds}+\frac{1}{2}V_{ds}^2-V_{th}V_{ds}$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzk5MTE4MjUzLDE2NzU4MDI4ODAsLTE0ND
