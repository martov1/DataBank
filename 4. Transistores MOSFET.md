...
**Notamos que:**
En la zona lineal, con **variaciones de** $V_{ds}$ tenemos variaciones **casi lineales** de $I_d$. esto significa que en esta zona el MOSFET se comporta como una resistencia.  el valor de la resistencia $R_{dson}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjgwNTcxNTM2LDE4NTM2NjkyMDgsNjE3OD
