...
![](https://i.imgur.com/LQMBHqo.png =x200)

* **Conocemos:**
	* $K$ - (cuando nosotros diseñamos el mosfet)
	* $R$ - La resistencia del circuito
	* $V_{th}$ - es una caracteristica del MOSFET
* **No conocemos:**
	* $V_{gs}$ - por que hay una caida en el resistor $R$
	* $I_d$
	* $V_{ds}$

Veamos como solucionarlo usando el modelo.
**1.** **Asumimos** que el MOSFET esta en **saturacion** y decidimos **ignorar el channel length modulation**, es decir que usaremos la equacion $(2)$

$I_d \approx k\frac{1}{2}(V_{gs}-V_{th})^2$
2. **por KVL** notamos que 
* $(4)\quad V_{gs}=V_{g}-RI_d$
![](https://i.imgur.com/EzJgDKQ.png =200x)
3. Reemplazando $(4)$ en $(2)$
*  $I_d \approx k\frac{1}{2}(\color{red}V_{g}-RI_d\color{normal}-V_{th})^2$
Ahora conocemos los valores y podemos hallar $I_d$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTczNjM2MzM1MiwxMzA5MjMxODUyLC00Mj
gyMjM2MzYsLTE1NzQ0OTQwNywtMzE1NTczNTExLDkxODA3ODMx
Niw5OTI2MDUyNDcsNDM4Njk4NzQzLC0xMzYwNDc1NTMyLC0xOT
kwNzM3NDMxLDcwODg4MTkwMywxMTE4NjA3MjQ4LC0xMzkzODI2
MDEwLDIwOTc5NTcwMzAsLTEwODA3MjMyNTUsNzMzMTM1MTEsLT
kzMzE2MjQ3NSwxNjYxNDQxMDA4LC00ODg5NTQ2MTIsLTg2Mzg0
MDk4N119
-->