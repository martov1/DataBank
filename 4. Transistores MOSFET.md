...
Se trata de **una simplificacion** que se puede hacer en determinadas circunstancias para facilitar el calculo.

Esta simplificacion se puede hacer cuando:
* Estas en la zona de saturacion
* los cambios en la señal de entrada $\Delta V{gs}$ son **chiquitos**


**Recordamos que:**
Cuando estamos usando el MOSFET como amplificador, primero elegimos un **bias point** y luego hacemos pequeñas variaciones de $V_{gs}$ que generan variaciones de $I_d$
![](https://i.imgur.com/E9ndGL7.png =400x)
A la pendiente (derivada) del grafico en ese bias point  le decimos **transductancia** y esa funcion nos dice el cambio de $I_d$ d

Si los cambios en $\Delta V{gs}$ son **chiquitos** entonces podes aproximar la corriente resultante usando
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMwNDQ3MTgzOCwtMTAzOTA3MDMyMSwtNj
gwOTY4NjcsMjAwODQ3MTQ2MCwxMzc2MDQxNDk3LDEzMDkyMzE4
NTIsLTQyODIyMzYzNiwtMTU3NDQ5NDA3LC0zMTU1NzM1MTEsOT
E4MDc4MzE2LDk5MjYwNTI0Nyw0Mzg2OTg3NDMsLTEzNjA0NzU1
MzIsLTE5OTA3Mzc0MzEsNzA4ODgxOTAzLDExMTg2MDcyNDgsLT
EzOTM4MjYwMTAsMjA5Nzk1NzAzMCwtMTA4MDcyMzI1NSw3MzMx
MzUxMV19
-->