...
* El channel, generado por $V_{gs}-V_{th}$
* La depletion region generada por el diodo ente drain y source y que esta polarizado inversamente por $V_{ds}$ 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTczNzI5MzA2MywxOTgxNjA2MDUxLC0yMT
