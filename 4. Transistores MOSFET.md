...
Esta linea **representa todas las combinaciones posibles de** $I_d$ y $V_{ds}$ que puede haber si el MOSFET fuera un **strong text**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxNDczOTkxNywtMjI4Mzg4MTY4LC0xMD
