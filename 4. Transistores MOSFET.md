...
**Recordamos** la **funcion de transferencia** del MOSFET, es decir como varia la **salida** $I_d$ con cambios de la **entrada** $V_{gs}$ mientras la segunda salida $V_{ds}$ se mantiene constante.
![](https://i.imgur.com/NYiagzk.png =400x)
**Recordamos:** 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MjEzNzAwNzMsNTEzNTg1MjM4LDEzND
