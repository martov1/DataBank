...
$(2) \quad \boxed{I_d (V_{gs}) \approx k\frac{1}{2}(V_{g}-V_{th})^2 }$
* Para zona lineal:
...
$I_d \approx k\frac{1}{2}(V_{g}-V_{th})^2$
2. **por KVL** notamos que $V_{gs}=V_{g}-RI_d$
![](https://i.imgur.com/EzJgDKQ.png =100x)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE4NTEwNTIwOCwxMzA5MjMxODUyLC00Mj
