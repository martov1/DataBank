...
* Este grafico asume que la segunda salida $V_{ds}$ es cte
...
**Entonces:** 
Si logramos mantenernos en la region de saturacion  ($V_{ds}>V_{gs}-V_{th}$), podemos montar una señal sobre la tension $V_{gs}$ y obtendremos como resultado una salida de corriente $I_d$ con una relacion **cuadratica de amplificacion!**

**OS** que  **un pequeño cambio** $\Delta V_{gs}$ generara **un gran cambio** $\Delta I_d$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzI1MDg1NDE5LC0xMTE1ODA4OTc3LDUxMz
