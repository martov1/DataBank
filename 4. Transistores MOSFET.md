...
Cuando la tension que esta permitiendo que se genere el channel $V_{gs}-V_{th}$ es mas chica que la tension que genera el depletion region del diodo $V_{gs}$ entonces la corriente que circula deja de aumentar.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMzNjY4ODAwMSwxOTgxNjA2MDUxLC0yMT
