...
Podemos entonces graficar todos los posibles valores de corriente $I_d$ en base a la caida de tension que pudiera tener el transistor! ($V_{ds}$), ese grafico es una recta que va

**Desde la corriente maxima, cuando el transistor esta en zona ohmica** 
Os(cuando $V_{ds}=0)$
$$(3) \quad I_{dmax}= 0+\frac{V_{fuente}}{R}$$
![](https://i.imgur.com/0zJZCR0.png =400x)[simulacion](https://tinyurl.com/y7anrlrj)

**Hasta corriente minima, cuando el transistor esta en CUTOFF** 
osea cuando$I_d=0$ que es cuando $V_{ds}=V_{fuente}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTUyNTg3NTYsLTY0NjI3NzcsMjk2OT
c3OTA1LC0zNjYyMTYyODUsMTE0Mzg5NjYwMiwxMDk4NjY3Mjg4
LDYxNjIwMDAwMCwtMTczNDU1NDE0NywtMzEzNTI4OTgsNzg1Nz
UwNTIsNDQ4MjA5NzQwLC0xNzA2Njk0NDE1LC0xNzA2Njk0NDE1
LDkxOTgzNzA0MiwyMTQyMjA1OTM2LDU1MjQ1MzI1OCwxOTQ2NT
cyNzM5LC0xMTQwMTE4NzA3LC01MTQwMjYyNjQsLTIyODM4ODE2
OF19
-->