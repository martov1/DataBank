...
$$\boxed{Q_{dg}=C_{dg} (V_{d}+ (V_{d}-V_{g}))}$$
...
**sumamos:**
$$Q_{sg}+Q_{dg}=C_{sg} V_{g}+C_{dg} (V_{dg-inicial}+V_{dg-final})$$
$$Q_{t}=C_{sg} V_{g}+C_{dg} (V_{dg-inicial}+V_{dg-final})$$
### Millers plateau - WIP
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU2NDQ5ODMxMywyNTIwODU4MzcsLTg5NT
