...
3. **Aproximar con el grafico la variacion de** $\Delta I_b$, conociendo previamente  la variacion  $\Delta V_{gs}$ que va a tener tu señal, tambien **muchas veces el fabricante te da el valor de transductancia mas conveniente** (menor $I_d$ para maxima   $\Delta V_{gs}$)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDM4Njk4NzQzLC0xMzYwNDc1NTMyLC0xOT
...
MDk4NywtMTQ1NjU2Mjc1MCwtOTg2NDkxNjgwLC0xMDQyMDkzMT
YzLDE3NjcxOTg0MzgsMTI2OTg1MjYxLC0zNTY5MzE0NDMsMTg0
MDc5NDE0N119
-->