...
5. **Ademas** si en algun momento $V_{g}-V_{th}=V_{cs}(x)$ el canal se cierra y no hay carga en esa coordenada $X$ del capacitor.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDQwNjY1ODMyLDY0MjY5NTY3OSw3MTIzMz
