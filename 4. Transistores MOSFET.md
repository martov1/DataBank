...
*  Generalmente la tension $V_{d}$ es la **tension de alimentacion** y puede ser
	...
	* **Muy baja  cuando el transistor esta conduciendo** ( $\approx 0V$)
...
* **Transistor encendido:** $V_{dg}\approx 200V$
* **Transistor apagado** $V_{dg}\approx -10V$

**TRANSISTOR APAGADO:**
$V_{dg}=600V$

Entonces cuando encendamos el capacitor, debemos descargarlo. es decir removerle la carga $Q$ que actualmente tiene.
...
Luego que descargu el capacitor tengo que **cargarlo al reves**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzOTAwODYzMywtMTk5NjMwNTM5MywtND
...
NjYyOSwtMjEzNzE0NzQ5OSw4NjYzMDA1MDYsLTE4NTkwNTY5NT
IsLTExOTc5OTY1MTUsLTQzMjU5MjU3LDIwMzcwNzI4OThdfQ==
