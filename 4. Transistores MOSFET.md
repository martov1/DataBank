...
Cuando $V_{ds}>V_{gs}-V_{th}$, el diodo queda en reverse bias formando un depletion region alrededor del drain
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5MjQzMjY2NywxOTgxNjA2MDUxLC0yMT
