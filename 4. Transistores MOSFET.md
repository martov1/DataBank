...
>$$(6) \quad Q_{libres}=\frac{C}{V_{gs}-V_{th}}$$

Reemplazando $(6)$ en $(5)$

$$I_d\approx \frac{\frac{C}{V_{gs}-V_{th}}\mu_QE}{L{}}$$
$$I_d\approx \frac{\frac{C\mu_QE}{L(V_{gs}-V_{th})}$$
Acomodando un poco
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY4OTQ4NzAzNCwtMTM1MzM3Mzc2OCwtOT
