...
### Definicion y ejemplo de uso - WIP
Es el modelo visto hasta ahora, donde usamos las equaciones "normales" del MOSFET que vimos hasta ahora.

Por ejemplo, el modelo de gran señal para saturacion es nuestra **clasica equacion de saturacion**.

$$\boxed{I_d (V_{gs}) \approx k\frac{1}{2}(V_{g}-V_{th})^2  (1+\lambda V_{ds})}$$

o en su version simplificada sin channel length modulation
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NTIwMzE3NzksLTE1NzQ0OTQwNywtMz
E1NTczNTExLDkxODA3ODMxNiw5OTI2MDUyNDcsNDM4Njk4NzQz
LC0xMzYwNDc1NTMyLC0xOTkwNzM3NDMxLDcwODg4MTkwMywxMT
E4NjA3MjQ4LC0xMzkzODI2MDEwLDIwOTc5NTcwMzAsLTEwODA3
MjMyNTUsNzMzMTM1MTEsLTkzMzE2MjQ3NSwxNjYxNDQxMDA4LC
00ODg5NTQ2MTIsLTg2Mzg0MDk4NywtMTQ1NjU2Mjc1MCwtOTg2
NDkxNjgwXX0=
-->