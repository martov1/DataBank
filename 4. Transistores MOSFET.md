...
**Vemos que** para un $V_{gs}$ determinado y fijo se respeta que  la relacion entre $V_{ds}$ y $I_d$ es una **recta** y **ese es el comporamiento de la ley de ohm**.

**Entonces:**
$$\frac{V_{ds}}{I_d}=R_{dsOn} \quad \quad \text{para un }  V_{gs} $$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTA4MjY4NTg3LC0xMDEyNTU3ODI2LC0yNz
E4NjU0NjcsLTE2NDk0OTgwODcsLTUzMTkxMTY1OSwxOTEwNjgx
ODI1LDIwNTUwOTE1NSwtMTU3NjI5MTEzMCwxNTYyNjY1MTc0LD
E0NDA2NzY0NjcsNzIyNTYzNjE4LDEyNzM5OTQ2NDksMTM0NzMy
MjEwOCwyMTEzMzc3NDQwLDc2NjUwMjc4NywtMTAwODYzMzM1NC
wxNDA1OTA0OTkwLC0zNjI5NTg5NDQsLTE0NzYzMTY3MTgsLTEz
Mjg1MDc4NTldfQ==
-->