...
* $R_{dsOn}$ tiene que estar entre $\color{green}\infty$ y $\color{orange}0$
* Entre $\color{orange}0\color{black}<R_{dsOn}<\color{green}\infty$, La relacion entre $V_{ds}$ y $I_d$ tiene que ser $\color{magenta}\text{lineal}$ por que respeta la ley de ohm
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDQ4Nzk0NTYsNTUyNDUzMjU4LDE5NDY1Nz
