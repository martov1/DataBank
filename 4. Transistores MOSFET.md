...
**Conclusion 2:**
Por el punto 1. si $V_{d}<V_{channel}<V_{s}$ entonces si $V_{ds}>V_{g}-V_{th}$ entonces por la concusion 1 exite un punto $X$ en donde $Q=0$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc4MzQzNzczMSwxNTM0MzA2MzA1LDIyMT
