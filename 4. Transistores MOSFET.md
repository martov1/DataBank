...
Una vez que elegiste un bias point $I_b$,  si tu **señal** $\Delta V_{gs}$ **es pequeña** entonces podes aproximar $\Delta I_d$ usando la **derivada del grafico** (transductancia)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTgwMjM4ODY5LC0xMDM5MDcwMzIxLC02OD
