...
Recordamos que tenemos 3 relaciones entre la entrada y la salida
* **CUTOFF**
* **ZONA LINEAL**
	* $I_d (V_{gs},V_{ds}) \approx k((V_{gs}-V_t)V_{ds}-\frac{1}{2}V_{ds}^2)$
* **ZONA DE SATURACION**
* $I_d (V_{gs}) \approx k\frac{1}{2}(V_{g}-V_{th})^2}$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzMjI4NjQ2MCwtMTgxNDQyOTExMywtMT
M5NTEzNzYzMywxODA3MTMxODEyLC01Nzc2MDYzNTUsNjI4MDY0
OTg2LC0xNDYxNjExNTMsMTA4Njg4MDQ2Nyw0NDA2NjU4MzIsNj
QyNjk1Njc5LDcxMjMzOTExOCwtMTE5NTcyODkxOCwxNDQ1NTI1
NDM1LDEwMzMxNjIwNCwtMTE2Mzg0NDgyNSw3NDk0MTc3ODUsMT
UzNDMwNjMwNSwyMjE0MDAzNDUsLTIwOTA3MTk1ODEsMTIzNzQ2
MTM5NV19
-->