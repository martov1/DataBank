...
![](https://i.imgur.com/3rZX0Xs.png =400x)
**Sabemos que:**
* La **corriente maxima** de este circuito se da cuando el mosfet conduce ($R_{dsOn}\approx0$) y sera limtada solo por **el circuito ALREDEDOR del mosfet** $\frac{V_{cc}}{R_{load}}$
* 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5MTU2NTM0NjksLTIyODM4ODE2OCwtMT
