...
Como la tension no sera homogenea no podemos usar el promedio de la tension $\frac{V_s+V_d}{2}$, sino que tenemos que hablar una funcion  $V_{channel}$ como funcion de la posicion $X$ 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NDk2NTYyNTEsMjIxNDAwMzQ1LC0yMD
