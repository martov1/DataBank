...
A partir de $V_{dsSat}$ en adelante no estas agrandando el canal, sino ue estas agrandando la depletion region y el canal queda con una carga $Q$ fija, por eso la corriente $I_d$ deja de crecer.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MDk2MDk2NzMsLTM1NjkzMTQ0MywxOD
