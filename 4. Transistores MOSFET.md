...
2. **Entonces** por la equacion $(5)$ existe un punto $X$ en donde $V_{cs}(x)=V_{g}-V_{th}$, llamamos a ese valor $V_{dsSat}$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA4Njg4MDQ2Nyw0NDA2NjU4MzIsNjQyNj
