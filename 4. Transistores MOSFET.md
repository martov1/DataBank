...
**ENTONCES:**
Vemos entonces como para **este circuito en particular** y estando en la **zona lineal**
* Eligiendo un valor de $V_{gs}$ podemos predecir $V{ds}$ y $I_d$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNDk3ODI2MDAsMTk0NjU3MjczOSwtMT
