...
* **Zona Saturacion**
	* Ocurre cuando  $V_{ds}>V_{gs}-V_{th}$
	* $I_d (V_{gs}) = k\frac{1}{2}(V_{g}-V_{th})^2$
	* Si $V_{gs}$ Es **una parabola**

**CRITICO:** 
Es importante notar que ahora la variable que cambia es $V_{ds}$, mientras que $V_{gs}$ es cte. eso significa que ahora la equacion  de la zona lineal es **una parabola**
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTUxMjI4NDU4OCwtNTE1OTg2NTU0LDE4OT
k2OTYxNTQsLTEzMjg2NTA5MzksLTM3NDI4NDIxNSw0MTQ1ODcz
NTcsLTE4MTQ0MjkxMTMsLTEzOTUxMzc2MzMsMTgwNzEzMTgxMi
wtNTc3NjA2MzU1LDYyODA2NDk4NiwtMTQ2MTYxMTUzLDEwODY4
ODA0NjcsNDQwNjY1ODMyLDY0MjY5NTY3OSw3MTIzMzkxMTgsLT
ExOTU3Mjg5MTgsMTQ0NTUyNTQzNSwxMDMzMTYyMDQsLTExNjM4
NDQ4MjVdfQ==
-->